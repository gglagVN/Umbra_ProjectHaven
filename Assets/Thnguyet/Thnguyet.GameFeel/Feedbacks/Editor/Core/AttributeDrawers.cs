...
{
	[CustomPropertyDrawer(typeof(FeedbackEnumConditionAttribute))]
	public class FeedbackEnumConditionAttributeDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			FeedbackEnumConditionAttribute enumConditionAttribute = (FeedbackEnumConditionAttribute)attribute;
		...
		private bool GetConditionAttributeResult(FeedbackEnumConditionAttribute enumConditionAttribute, SerializedProperty property)
		{
			bool enabled = true;
	...
	[CustomPropertyDrawer(typeof(FeedbackConditionAttribute))]
	public class FeedbackConditionAttributeDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			FeedbackConditionAttribute conditionAttribute = (FeedbackConditionAttribute)attribute;
		...
		private bool GetConditionAttributeResult(FeedbackConditionAttribute conditionAttribute, SerializedProperty property)
		{
			bool enabled = true;
			string propertyPath = property.propertyPath;
		...
		private bool ShouldDisplay(FeedbackConditionAttribute conditionAttribute, bool result)
		{
		...
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			...
			{
				/*int multiplier = 1; // this multiplier fixes issues in differing property spacing between FeelFeedbacks and FeedbackPlayer
				if (property.depth > 0)
				{
	...
	[CustomPropertyDrawer(typeof(FeedbackHiddenAttribute))]
	public class FeedbackHiddenAttributeDrawer : PropertyDrawer
	{
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			return 0f;
	...
	[CustomPropertyDrawer(typeof(FeedbackInformationAttribute))]
	/// <summary>
	/// This class allows the display of a message box (warning, info, error...) next to a property (before or after)
	/// </summary>
	public class FeedbackInformationAttributeDrawer : PropertyDrawer
	{
		...
		FeedbackInformationAttribute informationAttribute { get { return ((FeedbackInformationAttribute)attribute); } }
	...
	[CustomPropertyDrawer(typeof(FeedbackReadOnlyAttribute))]
	public class FeedbackReadOnlyAttributeDrawer : PropertyDrawer
	{
