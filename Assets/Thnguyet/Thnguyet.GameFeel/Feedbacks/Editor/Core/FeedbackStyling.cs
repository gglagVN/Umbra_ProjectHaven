...
{
	/// <summary>
	/// A class used to regroup most of the styling options for the FeelFeedback editors
	/// </summary>
	public static class FeedbackStyling
	{
		...
		static public Rect DrawHeader(ref bool expanded, ref bool activeField, string title, Color feedbackColor, System.Action<GenericMenu> fillGenericMenu, 
			float startedAt, float duration, float totalDuration, FeedbackTiming timing, bool pause, FeelFeedbacks host)
		{
			...
			if (timing.FeedbacksDirectionCondition == FeedbackTiming.FeedbacksDirectionConditions.OnlyWhenBackwards)
			{
			...
			if (timing.FeedbacksDirectionCondition == FeedbackTiming.FeedbacksDirectionConditions.OnlyWhenForwards)
			{
