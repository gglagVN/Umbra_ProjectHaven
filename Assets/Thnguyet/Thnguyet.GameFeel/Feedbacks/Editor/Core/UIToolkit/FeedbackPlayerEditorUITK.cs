...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackPlayerEditorUITK : Editor
	{
		...
		public class FeedbackFeedbackGroupExtrasContainerData
		{
			public VisualElement HeaderExtrasContainer;
			public FeedbackInspectorGroupData GroupData;
			public FeedbackInspectorDrawData DrawData;
		}
		...
		// Properties
		public FeedbackPlayer TargetMmfPlayer;
		...
		protected Dictionary<FeedbackFeedback, FeedbackHeaderContainersData> FeedbackHeaderContainersDictionary;
		protected Dictionary<FeedbackInspectorGroupData, FeedbackFeedbackGroupExtrasContainerData> FeedbackGroupsDictionary;
		...
		protected const string _inactiveMessage =
			"All FeelFeedbacks, including this one, are currently disabled. This is done via script, by changing the value of the FeelFeedbacks.GlobalMMFeedbacksActive boolean. Right now this value has been set to false. Setting it back to true will allow FeelFeedbacks to play again.";
		...
		protected const string _settingsText = "Feedback PLAYER SETTINGS";
		...
		protected const string _feedbackBaseName = "FeedbackFeedbackBase";
		...
		protected const string _channelModePropertyName = "FeedbackChannelMode";
		protected const string _channelPropertyName = "FeedbackChannel";
		protected const string _mmChannelDefinitionPropertyName = "FeedbackChannelDefinition";
		...
		protected virtual void OnFeedbackFieldValueChanged(SerializedProperty property, FeedbackInspectorGroupData groupData,
			FeedbackFeedback feedback) // triggers for any value changed anywhere on the feedback
		{
			...
			FeedbackFeedbackPropertyDrawerUITK.DrawGroupExtrasContainer(FeedbackGroupsDictionary[groupData]);
		}
		...
		{
			TargetMmfPlayer = (FeedbackPlayer)target;

			CacheFeedbacksListProperty();
			_inScriptDrivenPause = serializedObject.FindProperty(_inScriptDrivenPausePropertyName);
			PrepareFeedbackTypeList();

			FeedbackHeaderContainersDictionary = new Dictionary<FeedbackFeedback, FeedbackHeaderContainersData>();
			FeedbackGroupsDictionary = new Dictionary<FeedbackInspectorGroupData, FeedbackFeedbackGroupExtrasContainerData>();
			...
			// listen for changes on all properties in the Feedback Player
		...
		public virtual void DrawDurationAndDirectionContents()
		{
			...
			directionIcon.style.backgroundImage = (TargetMmfPlayer.Direction == FeedbackPlayer.Directions.BottomToTop)
		...
		protected virtual void DrawFeedbacksInactiveWarning(VisualElement root)
		{
			...
			if (!FeedbackPlayer.GlobalMMFeedbacksActive)
			{
		...
		protected virtual void DrawSettingsDropDown(VisualElement root)
		{
			...
			settingsInitializationFoldout.style.borderLeftColor =
				new StyleColor(FeelColors.CreateColor(249, 246, 216, 255));
			...
			{
				UIToolkit.CreateAndBindPropertyField(_initializationModePropertyName, serializedObject,
					settingsInitializationFoldout);
				UIToolkit.CreateAndBindPropertyField(_autoPlayOnStartPropertyName, serializedObject,
					settingsInitializationFoldout);
				UIToolkit.CreateAndBindPropertyField(_autoPlayOnEnablePropertyName, serializedObject,
					settingsInitializationFoldout);
				UIToolkit.CreateAndBindPropertyField(_autoInitializationPropertyName, serializedObject,
					settingsInitializationFoldout);
			}
			...
			settingsDirectionFoldout.style.borderLeftColor = new StyleColor(FeelColors.CreateColor(249, 244, 205, 255));
			HandleFoldoutChange(settingsDirectionFoldout, BuildSettingsDirectionFoldout);

			void BuildSettingsDirectionFoldout()
			{
				UIToolkit.CreateAndBindPropertyField(_directionPropertyName, serializedObject,
					settingsDirectionFoldout);
				UIToolkit.CreateAndBindPropertyField(_autoChangeDirectionOnEndPropertyName, serializedObject,
					settingsDirectionFoldout);
			}
			...
			settingsIntensityFoldout.style.borderLeftColor = new StyleColor(FeelColors.CreateColor(250, 238, 179, 255));
			HandleFoldoutChange(settingsIntensityFoldout, BuildIntensitySettingsFoldout);

			void BuildIntensitySettingsFoldout()
			{
				UIToolkit.CreateAndBindPropertyField(_feedbacksIntensityPropertyName, serializedObject,
			...
			settingsTimingFoldout.style.borderLeftColor = new StyleColor(FeelColors.CreateColor(251, 226, 128, 255));
			HandleFoldoutChange(settingsTimingFoldout, BuildSettingsTimingFoldout);

			void BuildSettingsTimingFoldout()
			{
				UIToolkit.CreateAndBindPropertyField(_durationMultiplierPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_randomizeDurationPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_randomDurationMultiplierPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_displayFullDurationDetailsPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_cooldownDurationPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_initialDelayPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_chanceToPlayPropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_playerTimescaleModePropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_forceTimescaleModePropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_forcedTimescaleModePropertyName, serializedObject,
					settingsTimingFoldout);
				UIToolkit.CreateAndBindPropertyField(_timescaleMultiplierPropertyName, serializedObject,
					settingsTimingFoldout);
			}
			...
			settingsRangeFoldout.style.borderLeftColor = new StyleColor(FeelColors.CreateColor(253, 216, 88, 255));
			...
			settingsPlaySettingsFoldout.style.borderLeftColor = new StyleColor(FeelColors.CreateColor(254, 209, 57, 255));
			HandleFoldoutChange(settingsPlaySettingsFoldout, BuildPlaySettingsFoldout);

			void BuildPlaySettingsFoldout()
			{
				UIToolkit.CreateAndBindPropertyField(_canPlayPropertyName, serializedObject, settingsPlaySettingsFoldout);
				UIToolkit.CreateAndBindPropertyField(_canPlayWhileAlreadyPlayingPropertyName, serializedObject, settingsPlaySettingsFoldout);
				UIToolkit.CreateAndBindPropertyField(_performanceModePropertyName, serializedObject, settingsPlaySettingsFoldout);
				UIToolkit.CreateAndBindPropertyField(_stopFeedbacksOnDisablePropertyName, serializedObject, settingsPlaySettingsFoldout);
				UIToolkit.CreateAndBindPropertyField(_restoreInitialValuesOnDisablePropertyName, serializedObject, settingsPlaySettingsFoldout);
				
				UIToolkit.CreateAndBindPropertyField(_channelModePropertyName, serializedObject, settingsPlaySettingsFoldout);
				UIToolkit.CreateAndBindPropertyField(_channelPropertyName, serializedObject, settingsPlaySettingsFoldout);
				UIToolkit.CreateAndBindPropertyField(_mmChannelDefinitionPropertyName, serializedObject, settingsPlaySettingsFoldout);

				if (Application.isPlaying)
				{
					UIToolkit.CreateAndBindPropertyField(_playCountPropertyName, serializedObject,
			...
			eventsField.RegisterCallback<GeometryChangedEvent>(evt =>
			{
				...
				if (eventsFieldFoldout != null)
				{
					...
					eventsFieldFoldout.style.borderLeftColor = new StyleColor(FeelColors.CreateColor(255, 197, 8, 255));
				}
		...
		protected virtual void AssembleFeedbacksList()
		{
			...
			_feedbacksListView.bindItem = (element, index) =>
			{
				...
				feedbackProgressBar.style.backgroundColor =
					TargetMmfPlayer.FeedbacksList[index].FeedbackColor.Lighten(0.3f);
				...
				FeedbackInspectorDrawData drawData = new FeedbackInspectorDrawData();
				...
				void DrawInspectorIfFoldoutIsOpen()
				{
					if (foldout.value)
					{
						...
						{
							feedbackInspectorContainer.Add(FeedbackFeedbackPropertyDrawerUITK.DrawInspector(drawData));
						}
					}
				}
		...
		{
			if ((TargetMmfPlayer.FeedbacksList[index].Timing.FeedbacksDirectionCondition ==
			     FeedbackTiming.FeedbacksDirectionConditions.OnlyWhenForwards)
			    || (TargetMmfPlayer.FeedbacksList[index].Timing.FeedbacksDirectionCondition ==
			        FeedbackTiming.FeedbacksDirectionConditions.OnlyWhenBackwards))
			{
				return (TargetMmfPlayer.FeedbacksList[index].Timing.FeedbacksDirectionCondition ==
				        FeedbackTiming.FeedbacksDirectionConditions.OnlyWhenBackwards)
					? new StyleBackground(BottomToTopIcon)
					: new StyleBackground(TopToBottomIcon);
			}
		...
		public virtual string DetermineFeedbackLabel(int index, Type feedbackType)
		{
			...
			{
				if ((TargetMmfPlayer.FeedbacksList[index] as FeedbackLooper).InfiniteLoop)
				{
				...
				else
				{
					_feedbackLabel = _feedbackLabel + "[" +
					                 (TargetMmfPlayer.FeedbacksList[index] as FeedbackLooper).NumberOfLoopsLeft +
					                 " loops left] ";
				}
			}
		...
		protected virtual void FillContextualMenu(DropdownMenu menu, int index, Type feedbackType)
		{
			...
			DropdownMenuAction.Status copyStatus = FeedbackPlayerCopy.HasCopy()
				? DropdownMenuAction.Status.Normal
				: DropdownMenuAction.Status.Disabled;
		...
		protected virtual VisualElement DrawBottomBarContents()
		{
			...
			// copy all button
			if (!FeedbackPlayerCopy.HasMultipleCopies())
			{
		...
		/// </summary>
		protected virtual FeedbackFeedback AddFeedback(System.Type type)
		{
			return (target as FeedbackPlayer).AddFeedback(type);
		}
		...
		protected virtual void RemoveFeedback(int id)
		{
			...
			(target as FeedbackPlayer).RemoveFeedback(id);
			SavePlayerChanges();
			RedrawFeedbacksList();
			SavePlayerChanges();
		}
		...
		protected virtual void ResetContextMenuFeedback(int id)
		{
			...
			Type feedbackType = (target as FeedbackPlayer).FeedbacksList[id].GetType();
			FeedbackFeedback newFeedback = (target as FeedbackPlayer).AddFeedback(feedbackType, false);
			(target as FeedbackPlayer).FeedbacksList[id] = newFeedback;
		...
		{
			FeedbackFeedback feedback = TargetMmfPlayer.FeedbacksList[id];
		...
		protected virtual void CopyFeedback(int id)
		{
			...
			FeedbackPlayerCopy.Copy(feedback);
		}
		...
		{
			FeedbackPlayerCopy.CopyAll(target as FeedbackPlayer);
			RedrawBottomBar();
		}
		...
		protected virtual void PasteAsNew()
		{
			...
			FeedbackPlayerCopy.PasteAll(this);
			SavePlayerChanges();
			RedrawBottomBar();
			RedrawFeedbacksList();
		}
