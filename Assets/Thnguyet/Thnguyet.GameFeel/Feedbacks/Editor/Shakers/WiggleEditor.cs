...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	[CustomEditor(typeof(FeelWiggle), true)]
	public class WiggleEditor : Editor
	{
		...
		protected FeelWiggle _mmWiggle;

		public bool StartWigglingAutomatically = true;

		protected virtual void OnEnable()
		{
			_mmWiggle = (FeelWiggle)target;
		...
		public override void OnInspectorGUI()
		{
			...
			Undo.RecordObject(target, "Modified FeelWiggle");            

			EditorGUILayout.Space();
			EditorGUILayout.PropertyField(_updateMode);
			EditorGUILayout.Space();
			FeedbackStyling.DrawSplitter();
		...
		protected virtual void DrawValueEditor(string title, SerializedProperty propertyActive, WiggleEditorProperties editorProperties, WiggleTypes wiggleType)
		{
			...
			Rect headerRect = FeedbackStyling.DrawSimpleHeader(
