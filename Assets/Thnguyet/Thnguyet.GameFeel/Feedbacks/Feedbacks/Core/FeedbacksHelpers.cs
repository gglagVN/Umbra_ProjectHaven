...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbacksHelpers : MonoBehaviour
	{
		...
		/// <summary>
		/// A helper used to migrate values from an AnimationCurve field to a TweenType, useful when updating
		/// old feedbacks to use them without losing legacy values 
		/// </summary>
		/// <param name="oldCurve"></param>
		/// <param name="newTweenType"></param>
		/// <param name="owner"></param>
		public static void MigrateCurve(AnimationCurve oldCurve, TweenType newTweenType, FeedbackPlayer owner)
		{
			if ((oldCurve.keys.Length > 0) && (!newTweenType.Initialized))
			{
				newTweenType.Curve = oldCurve;
				newTweenType.TweenDefinitionType = TweenDefinitionTypes.AnimationCurve;
				oldCurve = null;
	...
	public class FeedbackReadOnlyAttribute : PropertyAttribute { }

	[System.AttributeUsage(System.AttributeTargets.Field)]
	public class FeedbackInspectorButtonAttribute : PropertyAttribute
	{
		public readonly string MethodName;

		public FeedbackInspectorButtonAttribute(string MethodName)
		{
	...
	public class FeedbackEnumConditionAttribute : PropertyAttribute
	{
		...
		public FeedbackEnumConditionAttribute(string conditionBoolean, params int[] enumValues)
		{
	...
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof(FeedbackInspectorButtonAttribute))]
	public class FeedbackInspectorButtonPropertyDrawer : PropertyDrawer
	{
		private MethodInfo _eventMethodInfo = null;

		public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
		{
			FeedbackInspectorButtonAttribute inspectorButtonAttribute = (FeedbackInspectorButtonAttribute)attribute;
	...
	public class FeedbackInformationAttribute : PropertyAttribute
	{
		...
		public FeedbackInformationAttribute(string message, InformationType type, bool messageAfterProperty)
		{
	...
	public class FeedbackHiddenAttribute : PropertyAttribute { }
	...
	public class FeedbackConditionAttribute : PropertyAttribute
	{
		public string ConditionBoolean = "";
		public bool Hidden = false;
		public bool Negative = false;

		public FeedbackConditionAttribute(string conditionBoolean)
		{
		...
		public FeedbackConditionAttribute(string conditionBoolean, bool hideInInspector)
		{
			this.ConditionBoolean = conditionBoolean;
		...
		public FeedbackConditionAttribute(string conditionBoolean, bool hideInInspector, bool negative)
		{
			this.ConditionBoolean = conditionBoolean;
			this.Hidden = hideInInspector;
	...
	public class FeedbackVectorAttribute : PropertyAttribute
	{
		public readonly string[] Labels;

		public FeedbackVectorAttribute(params string[] labels)
		{
			Labels = labels;
		}
	}
	...
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof(FeedbackVectorAttribute))]
	public class VectorLabelsAttributeDrawer : PropertyDrawer
	{
		...
		{
			FeedbackVectorAttribute vector = (FeedbackVectorAttribute)attribute;
		...
		protected T[] DrawFields<T>(Rect rect, T[] vector, string mainLabel, System.Func<Rect, GUIContent, T, T> fieldDrawer, FeedbackVectorAttribute vectors, GUIContent originalGuiContent)
		{
			T[] result = vector;
	...
	public class FeedbackHiddenPropertiesAttribute : Attribute
	{
		public string[] PropertiesNames;

		public FeedbackHiddenPropertiesAttribute(params string[] propertiesNames)
		{
	...
	/// </summary>
	[AttributeUsage(AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Class | AttributeTargets.Struct, Inherited = true)]
	public class FeedbackInspectorGroupAttribute : PropertyAttribute
	{
		...
		public FeedbackInspectorGroupAttribute(string groupName, bool groupAllFieldsUntilNextGroupAttribute = false, int groupColorIndex = 24, bool requiresSetup = false, bool closedByDefault = false)
		{
	...
	public static class FeedbackStaticMethods
	{
		...
		public static Type FGetTypeByName(string name)
		{
		...
		/// <param name="this"></param>
		/// <returns></returns>
		public static T FGetComponentNoAlloc<T>(this GameObject @this) where T : Component
		{
		...
		/// <returns></returns>
		public static object FGetObjectValue(this SerializedProperty property)
		{
			if (property == null)
			{
				return null;
			...
			foreach (var element in elements)
			{
				if (!element.Contains("["))
				{
					targetObject = FGetPropertyValue(targetObject, element);
				}
				else
				{
					string elementName = element.Substring(0, element.IndexOf("["));
					int elementIndex = System.Convert.ToInt32(element.Substring(element.IndexOf("[")).Replace("[", "").Replace("]", ""));
					targetObject = FGetPropertyValue(targetObject, elementName, elementIndex);
				}
			}
			return targetObject;
		}
        
		private static object FGetPropertyValue(object source, string propertyName)
		{
			if (source == null)
			{
				return null;
		...
		private static object FGetPropertyValue(object source, string propertyName, int index)
		{
			var enumerable = FGetPropertyValue(source, propertyName) as System.Collections.IEnumerable;
			if (enumerable == null)
			{
				return null;
			}
	...
	public static class FeedbackFieldInfo
	{
		public static Dictionary<int, List<FieldInfo>> FieldInfoList = new Dictionary<int, List<FieldInfo>>();

        
		public static int GetFieldInfo(FeedbackFeedback target, out List<FieldInfo> fieldInfoList)
		{
