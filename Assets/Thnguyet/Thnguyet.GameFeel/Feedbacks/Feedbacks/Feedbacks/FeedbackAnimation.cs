...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackAnimation : FeedbackFeedback 
	{
		...
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return FeedbacksInspectorColors.AnimationColor; } }
		...
		[FeedbackInspectorGroup("Animation", true, 12, true)]
		...
		/// the duration for the player to consider. This won't impact your animation, but is a way to communicate to the Feedback Player the duration of this feedback. Usually you'll want it to match your actual animation, and setting it can be useful to have this feedback work with holding pauses.
		[Tooltip("the duration for the player to consider. This won't impact your animation, but is a way to communicate to the Feedback Player the duration of this feedback. Usually you'll want it to match your actual animation, and setting it can be useful to have this feedback work with holding pauses.")]
		public float DeclaredDuration = 0f;
        
		[FeedbackInspectorGroup("Trigger", true, 16)]
		...
		[FeedbackCondition("UpdateTrigger", true)]
		...
		[FeedbackInspectorGroup("Random Trigger", true, 20)]
		...
		/// the selected mode to interact with this trigger
		[Tooltip("the selected mode to interact with this trigger")]
		[FeedbackCondition("UpdateRandomTrigger", true)]
		...
		[FeedbackInspectorGroup("Bool", true, 17)]
		...
		[FeedbackCondition("UpdateBool", true)]
		...
		[FeedbackInspectorGroup("Random Bool", true, 19)]
		...
		/// the int parameter to turn true when the feedback gets played
		[Tooltip("the int parameter to turn true when the feedback gets played")]
		[FeedbackEnumCondition("IntValueMode", (int)ValueModes.Constant, (int)ValueModes.Random, (int)ValueModes.Incremental)]
		public string IntParameterName;
		/// the value to set to that int parameter
		[Tooltip("the value to set to that int parameter")]
		[FeedbackEnumCondition("IntValueMode", (int)ValueModes.Constant)]
		public int IntValue;
		...
		[FeedbackEnumCondition("IntValueMode", (int)ValueModes.Random)]
		...
		[FeedbackEnumCondition("IntValueMode", (int)ValueModes.Incremental)]
		public int IntIncrement = 1;

		[FeedbackInspectorGroup("Float", true, 22)]
		...
		/// the float parameter to turn true when the feedback gets played
		[Tooltip("the float parameter to turn true when the feedback gets played")]
		[FeedbackEnumCondition("FloatValueMode", (int)ValueModes.Constant, (int)ValueModes.Random, (int)ValueModes.Incremental)]
		public string FloatParameterName;
		/// the value to set to that float parameter
		[Tooltip("the value to set to that float parameter")]
		[FeedbackEnumCondition("FloatValueMode", (int)ValueModes.Constant)]
		...
		[FeedbackEnumCondition("FloatValueMode", (int)ValueModes.Random)]
		...
		[FeedbackEnumCondition("FloatValueMode", (int)ValueModes.Incremental)]
		public float FloatIncrement = 1;

		[FeedbackInspectorGroup("Layer Weights", true, 22)]
		...
		[FeedbackCondition("SetLayerWeight", true)]
