...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackAnimationCrossfade : FeedbackFeedback 
	{
		...
		[FeedbackInspectorGroup("CrossFade", true, 16)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Seconds)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Normalized)]
