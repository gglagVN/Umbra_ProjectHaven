...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackAnimatorPlayState : FeedbackFeedback 
	{
		...
		[FeedbackInspectorGroup("State", true, 16)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.NormalizedTime)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.FixedTime)]
