...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackAudioSourcePitch : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("AudioSource Pitch", true, 77)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			AudioSourcePitchShakeEvent.Trigger(PitchTween, FeedbackDuration, RemapPitchZero, RemapPitchOne, RelativePitch,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			AudioSourcePitchShakeEvent.Trigger(PitchTween, FeedbackDuration, RemapPitchZero, RemapPitchOne, RelativePitch, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			AudioSourcePitchShakeEvent.Trigger(PitchTween, FeedbackDuration, RemapPitchZero, RemapPitchOne, RelativePitch, restore:true);
		}
	}
}