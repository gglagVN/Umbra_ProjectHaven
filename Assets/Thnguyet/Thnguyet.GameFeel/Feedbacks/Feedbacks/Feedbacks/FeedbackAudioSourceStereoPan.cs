...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackAudioSourceStereoPan : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("AudioSource Stereo Pan", true, 48)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			AudioSourceStereoPanShakeEvent.Trigger(ShakeStereoPan, FeedbackDuration, RemapStereoPanZero, RemapStereoPanOne, RelativeStereoPan,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			AudioSourceStereoPanShakeEvent.Trigger(ShakeStereoPan, FeedbackDuration, RemapStereoPanZero, RemapStereoPanOne, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			AudioSourceStereoPanShakeEvent.Trigger(ShakeStereoPan, FeedbackDuration, RemapStereoPanZero, RemapStereoPanOne, restore:true);
		}
	}
}