...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackAudioSourceVolume : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("AudioSource Volume", true, 87)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			AudioSourceVolumeShakeEvent.Trigger(VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, RelativeVolume, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			AudioSourceVolumeShakeEvent.Trigger(VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			AudioSourceVolumeShakeEvent.Trigger(VolumeTween, FeedbackDuration, RemapVolumeZero, RemapVolumeOne, restore:true);
		}
	}
}