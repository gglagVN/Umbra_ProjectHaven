...
{
	/// <summary>
	/// This feedback lets you control a camera's clipping planes over time. You'll need a CameraClippingPlanesShaker on your camera.
	/// </summary>
	[AddComponentMenu("")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Camera/Clipping Planes")]
	[FeedbackHelp("This feedback lets you control a camera's clipping planes over time. You'll need a CameraClippingPlanesShaker on your camera.")]
	public class FeedbackCameraClippingPlanes : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Clipping Planes", true, 52)]
		...
		[FeedbackInspectorGroup("Near Plane", true, 53)]
		...
		[FeedbackInspectorGroup("Far Plane", true, 54)]
		/// the curve used to animate the intensity value on
		[Tooltip("the curve used to animate the intensity value on")]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			CameraClippingPlanesShakeEvent.Trigger(ShakeNear, FeedbackDuration, RemapNearZero, RemapNearOne, 
