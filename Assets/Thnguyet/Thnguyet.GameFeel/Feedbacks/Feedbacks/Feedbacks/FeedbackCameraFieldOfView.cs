...
{
	/// <summary>
	/// This feedback lets you control a camera's field of view over time. You'll need a CameraFieldOfViewShaker on your camera.
	/// </summary>
	[AddComponentMenu("")]
	...
	[FeedbackHelp(
		"This feedback lets you control a camera's field of view over time. You'll need a CameraFieldOfViewShaker on your camera.")]
	public class FeedbackCameraFieldOfView : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Field of View", true, 37)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			CameraFieldOfViewShakeEvent.Trigger(ShakeFieldOfView, FeedbackDuration, RemapFieldOfViewZero,
		...
		public override void AutomaticShakerSetup()
		{
			...
			CameraFieldOfViewShaker fieldOfViewShaker = (CameraFieldOfViewShaker)Object.FindAnyObjectByType(typeof(CameraFieldOfViewShaker));
			if (fieldOfViewShaker != null)
			{
				return;
			}

			Camera.main.gameObject.GetOrAddComponent<CameraFieldOfViewShaker>(); 
			FeelDebug.DebugLogInfo( "Added a CameraFieldOfViewShaker to the main camera. You're all set.");
		}
	}
}
