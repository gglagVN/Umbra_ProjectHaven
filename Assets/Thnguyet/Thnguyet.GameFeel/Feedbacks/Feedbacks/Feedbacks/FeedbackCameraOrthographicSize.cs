...
{
	/// <summary>
	/// This feedback lets you control a camera's orthographic size over time. You'll need a CameraOrthographicSizeShaker on your camera.
	/// </summary>
	[AddComponentMenu("")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Camera/Orthographic Size")]
	[FeedbackHelp("This feedback lets you control a camera's orthographic size over time. You'll need a CameraOrthographicSizeShaker on your camera.")]
	public class FeedbackCameraOrthographicSize : FeedbackFeedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor => FeedbacksInspectorColors.CameraColor; 
		...
		[FeedbackInspectorGroup("Orthographic Size", true, 41)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			CameraOrthographicSizeShakeEvent.Trigger(ShakeOrthographicSize, FeedbackDuration, RemapOrthographicSizeZero, RemapOrthographicSizeOne, RelativeOrthographicSize,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			CameraOrthographicSizeShakeEvent.Trigger(ShakeOrthographicSize, FeedbackDuration,
		...
		/// <summary>
		/// Automatically tries to add a CameraFieldOfViewShaker to the main camera, if none are present
		/// </summary>
		public override void AutomaticShakerSetup()
		{
			...
			CameraOrthographicSizeShaker orthographicSizeShaker = (CameraOrthographicSizeShaker)Object.FindAnyObjectByType(typeof(CameraOrthographicSizeShaker));
			if (orthographicSizeShaker != null)
			{
				return;
			}

			Camera.main.gameObject.GetOrAddComponent<CameraOrthographicSizeShaker>(); 
			FeelDebug.DebugLogInfo( "Added a CameraOrthographicSizeShaker to the main camera. You're all set.");
		}
	}
}
