...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	[FeedbackHelp("Define zoom properties : For will set the zoom to the specified parameters for a certain duration, " +
	              ...
	              "For this to work, you'll need to add a CameraZoom component to your Camera, or a CinemachineZoom if you're " +
	              "using virtual cameras.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Camera/Camera Zoom")]
	public class FeedbackCameraZoom : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Camera Zoom", true, 72)]
		...
		public CameraZoomModes ZoomMode = CameraZoomModes.For;
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			CameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, ChannelData, 
		...
		/// <summary>
		/// Automatically tries to add a CameraZoom to the main camera, if none are present
		/// </summary>
		public override void AutomaticShakerSetup()
		{
			...
			CameraZoom camZoom = (CameraZoom)Object.FindAnyObjectByType(typeof(CameraZoom));
			if (camZoom != null)
			{
				return;
			}

			Camera.main.gameObject.GetOrAddComponent<CameraZoom>(); 
			FeelDebug.DebugLogInfo( "Added a CameraZoom to the main camera. You're all set.");
		}
	}
}
