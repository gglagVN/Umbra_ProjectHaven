...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackDestinationTransform : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Target to animate", true, 61, true)]
		...
		[FeedbackCondition("ForceOrigin", true)] 
		...
		public TweenType GlobalAnimationTween = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
		...
		[FeedbackInspectorGroup("Axis Locks", true, 64)]
		...
		[FeedbackInspectorGroup("Separate Curves", true, 65)]
		...
		public TweenType AnimatePositionTween = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "SeparatePositionCurve");
		...
		public TweenType AnimateRotationTween = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "SeparateRotationCurve");
		...
		public TweenType AnimateScaleTween = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "SeparateScaleCurve");
		...
		protected TweenType _animationTweenType;
		...
		{
			base.OnValidate();
			FeedbacksHelpers.MigrateCurve(GlobalAnimationCurve, GlobalAnimationTween, Owner);
			FeedbacksHelpers.MigrateCurve(AnimatePositionCurve, AnimatePositionTween, Owner);
			FeedbacksHelpers.MigrateCurve(AnimateRotationCurve, AnimateRotationTween, Owner);
			FeedbacksHelpers.MigrateCurve(AnimateScaleCurve, AnimateScaleTween, Owner);
