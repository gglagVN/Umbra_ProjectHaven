...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackFlicker : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Flicker", true, 61, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.PropertyName)]
		...
		protected virtual void AcquireRenderers(FeedbackPlayer owner)
		{
			if (Active && (BoundRenderer == null) && (owner != null))
			{
				if (Owner.gameObject.FGetComponentNoAlloc<Renderer>() != null)
				{
