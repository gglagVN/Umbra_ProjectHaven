...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackGraphicCrossFade : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Graphic Cross Fade", true, 54, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Alpha)]
		public float TargetAlpha = 0.2f;
		/// the target color
		[Tooltip("the target color")]
		[FeedbackEnumCondition("Mode", (int)Modes.Color)]
