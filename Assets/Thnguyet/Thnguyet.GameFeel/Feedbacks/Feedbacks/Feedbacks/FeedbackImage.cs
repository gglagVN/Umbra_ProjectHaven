...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you change the color of a target Image over time. You can also use it to command one or many ImageShakers.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("UI/Image")]
	public class FeedbackImage : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Image", true, 54, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ToDestinationColor, (int)Modes.ToDestinationColorAndBack)]
