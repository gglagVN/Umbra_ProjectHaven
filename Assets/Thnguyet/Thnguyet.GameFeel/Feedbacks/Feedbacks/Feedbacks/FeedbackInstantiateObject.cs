...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackInstantiateObject : FeedbackFeedback
	{
		...
		[FeedbackCondition("RandomizePosition", true)]
		...
		[FeedbackInspectorGroup("Parent", true, 47)]
		...
		[FeedbackInspectorGroup("Object Pool", true, 40)]
		...
		[FeedbackCondition("CreateObjectPool", true)]
