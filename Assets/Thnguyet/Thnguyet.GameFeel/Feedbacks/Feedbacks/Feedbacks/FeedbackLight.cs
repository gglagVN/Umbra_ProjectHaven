...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackLight : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Range", true, 40, true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (Mode)
			{
				...
				case Modes.ShakerEvent:
					LightShakeEvent.Trigger(FeedbackDuration, RelativeValues, ModifyColor, ColorOverTime, IntensityCurve,
		...
		protected virtual void SetLightValues(float time, float intensityMultiplier)
		{
			...
			switch (Mode)
			{
				case Modes.OverTime:
					...
					range = FeedbacksHelpers.Remap(RangeCurve.Evaluate(time), 0f, 1f, RemapRangeZero, RemapRangeOne);
