...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// You can also use it to broadcast a LookAtShake event, that LookAtShakers on the right channel will be able to listen for and act upon 
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you animate the rotation of a transform to look at a target over time. You can also use it to broadcast a LookAtShake event, that LookAtShakers on the right channel will be able to listen for and act upon.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Transform/LookAt")]
	public class FeedbackLookAt : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Look at settings", true, 37, true)]
		...
		[FeedbackInspectorGroup("What we want to rotate", true, 37, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Direct)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Event)]
		...
		[FeedbackInspectorGroup("What we want to look at", true, 37, true)]
		...
		[FeedbackEnumCondition("LookAtTargetMode", (int)LookAtTargetModes.Transform)]
		...
		[FeedbackEnumCondition("LookAtTargetMode", (int)LookAtTargetModes.TargetWorldPosition)]
		...
		[FeedbackEnumCondition("LookAtTargetMode", (int)LookAtTargetModes.Direction)]
		...
		protected virtual void InitiateLookAt(Vector3 position)
		{
			...
			switch (Mode)
			{
				case Modes.Direct:
					...
					break;
				case Modes.Event:
					LookAtShaker.LookAtShakeEvent.Trigger(Duration, LockXAxis, LockYAxis, LockZAxis, UpwardVector,
