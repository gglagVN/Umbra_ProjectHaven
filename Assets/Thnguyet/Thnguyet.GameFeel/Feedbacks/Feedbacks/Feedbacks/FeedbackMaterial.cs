...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackMaterial : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Target Material", true, 61, true)]
		...
		[FeedbackInspectorGroup("Interpolation", true, 35)]
		...
		protected virtual IEnumerator TransitionMaterial(Material originalMaterial, Material newMaterial, int materialIndex)
		{
			...
			{
				float time = FeedbacksHelpers.Remap(GetTime() - _startedAt, 0f, TransitionDuration, 0f, 1f);
