...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackMaterialSetProperty : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Material", true, 12, true)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Color)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Integer)]
		public int NewInt;
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.TextureOffset)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.TextureScale)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Vector)]
		...
		[FeedbackCondition("InterpolateValue", true)]
		public float Duration = 2f;
		/// the curve over which to interpolate the value
		[Tooltip("the curve over which to interpolate the value")]
		public TweenType InterpolationCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "InterpolateValue");
		...
		protected virtual void SetValueAtTime(float t, float intensityMultiplier)
		{
			...
			{
				case PropertyTypes.Color:
					float evaluated = FeelTween.Tween(t, 0f, 1f, _initialFloat, NewFloat, InterpolationCurve);
					_newColor = Color.Lerp(_initialColor, NewColor, evaluated);
					SetColor(_newColor);
					break;
				case PropertyTypes.Float:
					float newFloatValue = FeelTween.Tween(t, 0f, 1f, _initialFloat, NewFloat, InterpolationCurve);
					SetFloat(newFloatValue);
					break;
				case PropertyTypes.Integer:
					int newIntValue = (int)FeelTween.Tween(t, 0f, 1f, _initialInt, NewInt, InterpolationCurve);
					SetInt(newIntValue);
					break;
				case PropertyTypes.Texture:
					SetTexture(NewTexture);
					break;
				case PropertyTypes.TextureOffset:
					_newVector2 = FeelTween.Tween(t, 0f, 1f, _initialOffset, NewOffset, InterpolationCurve);
					SetTextureOffset(_newVector2);
					break;
				case PropertyTypes.TextureScale:
					_newVector2 = FeelTween.Tween(t, 0f, 1f, _initialScale, NewScale, InterpolationCurve);
					SetTextureScale(_newVector2);
					break;
				case PropertyTypes.Vector:
					_newVector4 = FeelTween.Tween(t, 0f, 1f, _initialVector, NewVector, InterpolationCurve);
