...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackPause : FeedbackFeedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return FeedbacksInspectorColors.PauseColor; } }
		public override Color DisplayColor { get { return FeedbacksInspectorColors.PauseColor.Darken(0.25f); } }
		public override bool DisplayFullHeaderColor => true;
		#endif
		public override IEnumerator Pause { get { return PauseWait(); } }
        
		[FeedbackInspectorGroup("Pause", true, 32)]
		...
		[FeedbackCondition("RandomizePauseDuration", true)]
		...
		/// if this is true, you'll need to call the ResumeFeedbacks() method on the host FeedbackPlayer for this pause to stop, and the rest of the sequence to play
		[Tooltip("if this is true, you'll need to call the ResumeFeedbacks() method on the host FeedbackPlayer for this pause to stop, and the rest of the sequence to play")]
		...
		[FeedbackCondition("ScriptDriven", true)]
		...
		[FeedbackCondition("AutoResume", true)]
