...
{
	/// <summary>
	/// This feedback allows you to chain any number of target Feedback Players and play them in sequence, with optional delays before and after
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback allows you to chain any number of target Feedback Players and play them in sequence, with optional delays before and after")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Feedbacks/Feedback Player Chain")]
	public class FeedbackPlayerChain : FeedbackFeedback
	{
		/// <summary>
		/// A class used to store and define items in a chain of Feedback Players
		/// </summary>
		[Serializable]
		public class PlayerChainItem
		{
			/// the target Feedback Player 
			[Tooltip("the target Feedback Player")]
			public FeedbackPlayer TargetPlayer;
			/// a delay in seconds to wait for before playing this Feedback Player (x) and after (y)
			[Tooltip("a delay in seconds to wait for before playing this Feedback Player (x) and after (y)")]
			[Vector("Before", "After")]
		...
		/// the list of Feedback Player that make up the chain. The chain's items will be played from index 0 to the last in the list
		[Tooltip("the list of Feedback Player that make up the chain. The chain's items will be played from index 0 to the last in the list")]
