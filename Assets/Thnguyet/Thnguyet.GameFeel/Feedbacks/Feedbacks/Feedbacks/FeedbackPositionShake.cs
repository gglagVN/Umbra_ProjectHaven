...
{
	/// <summary>
	/// This feedback lets you emit a PositionShake event. This will be caught by PositionShakers (on the specified channel).
	...
	[FeedbackHelp("This feedback lets you emit a PositionShake event. This will be caught by PositionShakers (on the specified channel)." +
	              " Position shakers, as the name suggests, are used to shake the position of a transform, along a direction, with optional noise and other fine control options.")]
	public class FeedbackPositionShake : FeedbackFeedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetShaker = FindAutomatedTarget<PositionShaker>();
		...
		public PositionShaker TargetShaker;
		
		[FeedbackInspectorGroup("Position Shake", true, 28)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				PositionShakeEvent.Trigger(FeedbackDuration, ShakeSpeed,  ShakeRange,  ShakeMainDirection,  RandomizeDirection,  ShakeAltDirection,  RandomizeDirectionOnPlay,  
