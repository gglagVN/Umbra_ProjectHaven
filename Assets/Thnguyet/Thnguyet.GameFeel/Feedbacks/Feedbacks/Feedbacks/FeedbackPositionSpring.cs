...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackPositionSpring : FeedbackFeedback
	{
		...
		/// spring duration is determined by the spring (and could be impacted real time), so it's up to you to determine how long this feedback should last, from the point of view of its parent Feedback Player
		[Tooltip("spring duration is determined by the spring (and could be impacted real time), so it's up to you to determine how long this feedback should last, from the point of view of its parent Feedback Player")]
		...
		[FeedbackInspectorGroup("Spring Settings", true, 18)]
		...
		[FeedbackInspectorGroup("Spring Mode", true, 19)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.MoveTo, (int)Modes.MoveToAdditive)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Bump)]
		...
		protected virtual void UpdateSpring()
		{
			...
			FeelMaths.Spring(ref _currentValue.x, _targetValue.x, ref _velocity.x, DampingX, FrequencyX, FeedbackDeltaTime);
			FeelMaths.Spring(ref _currentValue.y, _targetValue.y, ref _velocity.y, DampingY, FrequencyY, FeedbackDeltaTime);
			FeelMaths.Spring(ref _currentValue.z, _targetValue.z, ref _velocity.z, DampingZ, FrequencyZ, FeedbackDeltaTime);
			ApplyValue();
		}
