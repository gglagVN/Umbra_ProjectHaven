...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	[System.Serializable]
	[FeedbackPath("Feedbacks/Feedback Reference Holder")]
	public class FeedbackReferenceHolder : FeedbackFeedback
	{
		...
		public override Color DisplayColor { get { return FeedbacksInspectorColors.FeedbacksColor.Darken(0.15f); } }
		...
		[FeedbackInspectorGroup("References", true, 37, true)]
		...
		/// whether or not to force this reference holder on all compatible feedbacks in the Feedback Player's list
		[Tooltip("whether or not to force this reference holder on all compatible feedbacks in the Feedback Player's list")] 
