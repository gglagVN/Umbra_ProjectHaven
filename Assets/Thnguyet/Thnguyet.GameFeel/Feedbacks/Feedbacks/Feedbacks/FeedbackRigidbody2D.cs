...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackRigidbody2D : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Rigidbody2D", true, 32, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.AddForce, (int)Modes.AddRelativeForce)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.AddTorque)]
