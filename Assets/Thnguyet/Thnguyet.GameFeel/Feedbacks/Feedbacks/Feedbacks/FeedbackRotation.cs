...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackRotation : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Rotation Target", true, 61, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Absolute, (int)Modes.Additive)]
		...
		public TweenType AnimateRotationTweenX = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "AnimateX");
		...
		public TweenType AnimateRotationTweenY = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "AnimateY");
		...
		public TweenType AnimateRotationTweenZ = new TweenType( new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "AnimateZ");
		...
		/// how the x part of the rotation should animate over time, in degrees
		[Tooltip("how the x part of the rotation should animate over time, in degrees")]
		public TweenType ToDestinationTween = new TweenType(FeelTween.TweenCurve.EaseInQuintic, "", "Mode", (int)Modes.ToDestination);
		...
		protected virtual void ApplyRotation(Transform targetTransform, float remapZero, float remapOne, TweenType curveX, TweenType curveY, TweenType curveZ, float percent)
		{
			...
			if (AnimateX)
			{
				float x = FeelTween.Tween(percent, 0f, 1f, remapZero, remapOne, curveX);
				targetTransform.Rotate(Vector3.right, x, RotationSpace);
			}
			if (AnimateY)
			{
				float y = FeelTween.Tween(percent, 0f, 1f, remapZero, remapOne, curveY);
				targetTransform.Rotate(Vector3.up, y, RotationSpace);
			}
			if (AnimateZ)
			{
				float z = FeelTween.Tween(percent, 0f, 1f, remapZero, remapOne, curveZ);
		...
		{
			base.OnValidate();
			FeedbacksHelpers.MigrateCurve(AnimateRotationX, AnimateRotationTweenX, Owner);
			FeedbacksHelpers.MigrateCurve(AnimateRotationY, AnimateRotationTweenY, Owner);
			FeedbacksHelpers.MigrateCurve(AnimateRotationZ, AnimateRotationTweenZ, Owner);
			FeedbacksHelpers.MigrateCurve(ToDestinationCurve, ToDestinationTween, Owner);
