...
{
	/// <summary>
	/// This feedback lets you emit a RotationShake event. This will be caught by RotationShakers (on the specified channel).
	...
	[FeedbackHelp("This feedback lets you emit a RotationShake event. This will be caught by RotationShakers (on the specified channel)." +
	              " Rotation shakers, as the name suggests, are used to shake the rotation of a transform, along a direction, with optional noise and other fine control options.")]
	public class FeedbackRotationShake : FeedbackFeedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetShaker = FindAutomatedTarget<RotationShaker>();

		[FeedbackInspectorGroup("Optional Target", true, 33)]
		...
		public RotationShaker TargetShaker;
		
		[FeedbackInspectorGroup("Rotation Shake", true, 28)]
		...
		[FeedbackInspectorGroup("Shake Settings", true, 42)]
		...
		[FeedbackInspectorGroup("Direction", true, 43)]
		...
		[FeedbackCondition("RandomizeDirection", true)]
		...
		[FeedbackInspectorGroup("Directional Noise", true, 47)]
		...
		[FeedbackCondition("AddDirectionalNoise", true)]
		...
		[FeedbackInspectorGroup("Randomness", true, 44)]
		...
		[FeedbackInspectorGroup("One Time", true, 45)]
		...
		[FeedbackCondition("UseAttenuation", true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				RotationShakeEvent.Trigger(FeedbackDuration, ShakeSpeed,  ShakeRange,  ShakeMainDirection,  RandomizeDirection,  ShakeAltDirection,  RandomizeDirectionOnPlay,  AddDirectionalNoise, 
