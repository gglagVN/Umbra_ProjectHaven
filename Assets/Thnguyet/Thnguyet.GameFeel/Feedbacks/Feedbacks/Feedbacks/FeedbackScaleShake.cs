...
{
	/// <summary>
	/// This feedback lets you emit a ScaleShake event. This will be caught by ScaleShakers (on the specified channel).
	...
	[FeedbackHelp("This feedback lets you emit a ScaleShake event. This will be caught by ScaleShakers (on the specified channel)." +
	              " Scale shakers, as the name suggests, are used to shake the scale of a transform, along a direction, with optional noise and other fine control options.")]
	public class FeedbackScaleShake : FeedbackFeedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetShaker = FindAutomatedTarget<ScaleShaker>();
		...
		public ScaleShaker TargetShaker;
		
		[FeedbackInspectorGroup("Scale Shake", true, 28)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			{
				ScaleShakeEvent.Trigger(FeedbackDuration, ShakeSpeed,  ShakeRange,  ShakeMainDirection,  RandomizeDirection,  ShakeAltDirection,  RandomizeDirectionOnPlay,  AddDirectionalNoise, 
