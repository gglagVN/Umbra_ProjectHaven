...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackSetActive : FeedbackFeedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor => FeedbacksInspectorColors.GameObjectColor; 
		...
		[FeedbackInspectorGroup("Set Active Target", true, 12, true)]
		...
		[FeedbackInspectorGroup("States", true, 14)]
		...
		[FeedbackCondition("SetStateOnInit", true)]
		...
		[FeedbackCondition("SetStateOnPlay", true)]
		...
		[FeedbackCondition("SetStateOnStop", true)]
		...
		[FeedbackCondition("SetStateOnReset", true)]
		...
		[FeedbackCondition("SetStateOnSkip", true)]
		...
		[FeedbackCondition("SetStateOnPlayerComplete", true)]
