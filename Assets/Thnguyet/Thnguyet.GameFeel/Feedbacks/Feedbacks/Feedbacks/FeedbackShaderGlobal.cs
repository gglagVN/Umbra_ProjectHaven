...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackShaderGlobal : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Shader Global", true, 24)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.SetGlobalColor, (int)Modes.SetGlobalFloat, (int)Modes.SetGlobalInt, (int)Modes.SetGlobalMatrix, (int)Modes.SetGlobalTexture, (int)Modes.SetGlobalVector)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.SetGlobalColor)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.SetGlobalTexture)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.SetGlobalVector)]
		public Vector4 GlobalVector;
		/// a global shader keyword
		[Tooltip("a global shader keyword")] 
		[FeedbackEnumCondition("Mode", (int)Modes.EnableKeyword, (int)Modes.DisableKeyword)]
