...
{
	/// <summary>
	/// This feedback will let you change the color of a target sprite renderer over time, and flip it on X or Y. You can also use it to command one or many SpriteRendererShakers.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you change the color of a target sprite renderer over time, and flip it on X or Y. You can also use it to command one or many SpriteRendererShakers.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Renderer/SpriteRenderer")]
	public class FeedbackSpriteRenderer : FeedbackFeedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return FeedbacksInspectorColors.RendererColor; } }
		...
		[FeedbackInspectorGroup("Sprite Renderer", true, 51, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent, (int)Modes.ToDestinationColor, (int)Modes.ToDestinationColorAndBack)]
		...
		[FeedbackInspectorGroup("Color", true, 52)]
		...
		[Tooltip("the color to move to in instant mode")]
		[FeedbackEnumCondition("Mode", (int)Modes.Instant, (int)Modes.ToDestinationColor, (int)Modes.ToDestinationColorAndBack)]
		...
		[FeedbackInspectorGroup("Flip", true, 53)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (Mode)
			{
				...
				case Modes.ShakerEvent:
					SpriteRendererShakeEvent.Trigger(FeedbackDuration, ModifyColor, ColorOverTime, 
						FlipX, FlipY,   
						intensityMultiplier,
			...
			while ((journey >= 0) && (journey <= FeedbackDuration) && (FeedbackDuration > 0))
			{
				...
				if (andBack)
				{
					remappedTime = (remappedTime < 0.5f)
						? FeedbacksHelpers.Remap(remappedTime, 0f, 0.5f, 0f, 1f)
						: FeedbacksHelpers.Remap(remappedTime, 0.5f, 1f, 1f, 0f);
				}
