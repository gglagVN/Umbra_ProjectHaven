...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackSpriteRendererAlpha : FeedbackFeedback
	{
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ToDestinationAlpha, (int)Modes.ToDestinationAlphaAndBack)]
		...
		[FeedbackEnumCondition("Mode",  (int)Modes.ToDestinationAlpha, (int)Modes.ToDestinationAlphaAndBack)]
		...
		protected virtual IEnumerator SpriteRendererToDestinationSequence(bool andBack)
		{
			...
			while ((journey >= 0) && (journey <= FeedbackDuration) && (FeedbackDuration > 0))
			{
				...
				float newAlpha = FeelMaths.Remap(curveValue, 0f, 1f, _initialAlpha, ToDestinationAlpha);
				SetAlpha(newAlpha);
		...
		{
			BoundSpriteRenderer.color = BoundSpriteRenderer.color.Alpha(newAlpha);
		}
