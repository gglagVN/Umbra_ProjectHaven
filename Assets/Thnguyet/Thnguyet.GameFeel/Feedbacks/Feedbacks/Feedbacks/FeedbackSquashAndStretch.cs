...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackSquashAndStretch : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Squash & Stretch", true, 54, true)]
		...
		protected virtual IEnumerator ScaleToDestination()
		{
			...
			while ((journey >= 0) && (journey <= FeedbackDuration) && (FeedbackDuration > 0))
			{
				...
				newScale = FeedbacksHelpers.Remap(newScale, 0f, 1f, RemapCurveZero, RemapCurveOne);
