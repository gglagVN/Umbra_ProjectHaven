...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackSquashAndStretchSpring : FeedbackFeedback
	{
		...
		{
			FeelMaths.Spring(ref _currentValue, _targetValue, ref _velocity, Damping, Frequency, FeedbackDeltaTime);
			ApplyValue();
		}
