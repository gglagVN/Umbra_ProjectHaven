...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTextureOffset : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Texture Scale", true, 63, true)]
		...
		[FeedbackInspectorGroup("Intensity", true, 65)]
		...
		{
			_newValue.x = FeedbacksHelpers.Remap(OffsetCurve.Evaluate(time), 0f, 1f, RemapZero.x, RemapOne.x);
			_newValue.y = FeedbacksHelpers.Remap(OffsetCurve.Evaluate(time), 0f, 1f, RemapZero.y, RemapOne.y);
