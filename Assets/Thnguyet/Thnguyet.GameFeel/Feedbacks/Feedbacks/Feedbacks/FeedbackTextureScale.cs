...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTextureScale : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Texture Scale", true, 62, true)]
		...
		[FeedbackInspectorGroup("Intensity", true, 64)]
		...
		{
			_newValue.x = FeedbacksHelpers.Remap(ScaleCurve.Evaluate(time), 0f, 1f, RemapZero.x, RemapOne.x);
			_newValue.y = FeedbacksHelpers.Remap(ScaleCurve.Evaluate(time), 0f, 1f, RemapZero.y, RemapOne.y);
