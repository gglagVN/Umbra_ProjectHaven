...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackUnloadScene : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Unload Scene", true, 43, false)]
		...
		[FeedbackEnumCondition("Method", (int)Methods.BuildIndex)]
		public int BuildIndex = 0;

		/// the name of the scene to unload
		[Tooltip("the name of the scene to unload")]
		[FeedbackEnumCondition("Method", (int)Methods.SceneName)]
