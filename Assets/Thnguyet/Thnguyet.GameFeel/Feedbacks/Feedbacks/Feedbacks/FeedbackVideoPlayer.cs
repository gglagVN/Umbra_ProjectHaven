...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackVideoPlayer : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Video Player", true, 58, true)]
		...
		[FeedbackEnumCondition("VideoAction", (int)VideoActions.GoToFrame)]
		public long TargetFrame = 10;
		/// the new playback speed (between 0 and 10)
		[Tooltip("the new playback speed (between 0 and 10)")]
		[FeedbackEnumCondition("VideoAction", (int)VideoActions.SetPlaybackSpeed)]
		...
		[FeedbackEnumCondition("VideoAction", (int)VideoActions.SetDirectAudioMute, (int)VideoActions.SetDirectAudioVolume)]
		public int TrackIndex = 0;
		/// the new volume for the specified track, between 0 and 1
		[Tooltip("the new volume for the specified track, between 0 and 1")]
		[FeedbackEnumCondition("VideoAction", (int)VideoActions.SetDirectAudioVolume)]
		...
		[FeedbackEnumCondition("VideoAction", (int)VideoActions.SetDirectAudioMute)]
