...
{
	/// <summary>
	/// When played, this feedback will activate the Wiggle method of a FeelWiggle object based on the selected settings, wiggling either its position, rotation, scale, or all of these.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback lets you trigger position, rotation and/or scale wiggles on an object equipped with a FeelWiggle component, for the specified durations.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks")]
	[System.Serializable]
	[FeedbackPath("Transform/Wiggle")]
	public class FeedbackWiggle : FeedbackFeedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetWiggle = FindAutomatedTarget<FeelWiggle>();

		[FeedbackInspectorGroup("Target", true, 54, true)]
		/// the Wiggle component to target
		[Tooltip("the Wiggle component to target")]
		public FeelWiggle TargetWiggle;
        
		[FeedbackInspectorGroup("Position", true, 55)]
		...
		[FeedbackInspectorGroup("Rotation", true, 26)]
		...
		[FeedbackInspectorGroup("Scale", true, 57)]
