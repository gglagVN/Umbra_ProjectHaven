...
{
	/// <summary>
	/// A FeelSequencer with ready made slots to play AudioSources
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Sequencing/AudioSource Sequencer")]
	public class AudioSourceSequencer : FeelSequencer
	{
