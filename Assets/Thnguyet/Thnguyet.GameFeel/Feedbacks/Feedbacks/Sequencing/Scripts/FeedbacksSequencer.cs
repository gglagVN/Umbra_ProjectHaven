...
{
	/// <summary>
	/// A FeelSequencer with ready made slots to play FeelFeedbacks
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Sequencing/Feedbacks Sequencer")]
	public class FeedbacksSequencer : FeelSequencer
	{
		/// the list of audio clips to play (one per track)
		[Tooltip("the list of audio clips to play (one per track)")]
		public List<FeelFeedbacks> Feedbacks;
