...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Sequencing/Input Sequence Recorder")]
	[ExecuteAlways]
	public class InputSequenceRecorder : MonoBehaviour
	{
		[Header("Target")]
		/// the target scriptable object to write to
		[Tooltip("the target scriptable object to write to")]
		public FeelSequence SequenceScriptableObject;
		...
		protected virtual void DetectRecording()
		{
			...
			{
				foreach (SequenceTrack track in SequenceScriptableObject.SequenceTracks)
				{                    
		...
		public virtual void AddNoteToTrack(SequenceTrack track)
		{
