...
{
	/// <summary>
	/// A FeelSequencer with ready made slots to play sounds
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Sequencing/Sound Sequencer")]
	public class SoundSequencer : FeelSequencer
	{
