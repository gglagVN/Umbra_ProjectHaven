...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Filter Distortion Shaker")]
	[RequireComponent(typeof(AudioDistortionFilter))]
	public class AudioFilterDistortionShaker : FeelShaker
	{
		[InspectorGroup("Distortion", true, 51)]
		...
		{
			base.StartListening();
			AudioFilterDistortionShakeEvent.Register(OnMMAudioFilterDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioFilterDistortionShakeEvent.Unregister(OnMMAudioFilterDistortionShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioFilterDistortionShakeEvent
	{
