...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Filter Echo Shaker")]
	[RequireComponent(typeof(AudioEchoFilter))]
	public class AudioFilterEchoShaker : FeelShaker
	{
		[InspectorGroup("Echo", true, 52)]
		...
		{
			base.StartListening();
			AudioFilterEchoShakeEvent.Register(OnMMAudioFilterEchoShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioFilterEchoShakeEvent.Unregister(OnMMAudioFilterEchoShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioFilterEchoShakeEvent
	{
