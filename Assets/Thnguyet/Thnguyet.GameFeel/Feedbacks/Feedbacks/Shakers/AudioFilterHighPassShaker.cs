...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Filter High Pass Shaker")]
	[RequireComponent(typeof(AudioHighPassFilter))]
	public class AudioFilterHighPassShaker : FeelShaker
	{
		[InspectorGroup("High Pass", true, 53)]
		...
		{
			base.StartListening();
			AudioFilterHighPassShakeEvent.Register(OnMMAudioFilterHighPassShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioFilterHighPassShakeEvent.Unregister(OnMMAudioFilterHighPassShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioFilterHighPassShakeEvent
	{
