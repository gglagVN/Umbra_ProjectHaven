...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Filter Low Pass Shaker")]
	[RequireComponent(typeof(AudioLowPassFilter))]
	public class AudioFilterLowPassShaker : FeelShaker
	{
		[InspectorGroup("Low Pass", true, 54)]
		...
		{
			base.StartListening();
			AudioFilterLowPassShakeEvent.Register(OnMMAudioFilterLowPassShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioFilterLowPassShakeEvent.Unregister(OnMMAudioFilterLowPassShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioFilterLowPassShakeEvent
	{
