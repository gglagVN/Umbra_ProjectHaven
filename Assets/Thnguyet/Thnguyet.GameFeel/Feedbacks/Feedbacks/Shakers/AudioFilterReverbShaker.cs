...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Filter Reverb Shaker")]
	[RequireComponent(typeof(AudioReverbFilter))]
	public class AudioFilterReverbShaker : FeelShaker
	{
		[InspectorGroup("Reverb", true, 55)]
		...
		{
			base.StartListening();
			AudioFilterReverbShakeEvent.Register(OnMMAudioFilterReverbShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioFilterReverbShakeEvent.Unregister(OnMMAudioFilterReverbShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioFilterReverbShakeEvent
	{
