...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Source Pitch Shaker")]
	[RequireComponent(typeof(AudioSource))]
	public class AudioSourcePitchShaker : FeelShaker
	{
		[InspectorGroup("Pitch", true, 57)]
		...
		{
			base.StartListening();
			AudioSourcePitchShakeEvent.Register(OnMMAudioSourcePitchShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioSourcePitchShakeEvent.Unregister(OnMMAudioSourcePitchShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioSourcePitchShakeEvent
	{
