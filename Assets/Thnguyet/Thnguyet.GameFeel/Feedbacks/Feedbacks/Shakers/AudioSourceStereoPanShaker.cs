...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Source Stereo Pan Shaker")]
	[RequireComponent(typeof(AudioSource))]
	public class AudioSourceStereoPanShaker : FeelShaker
	{
		[InspectorGroup("Stereo Pan", true, 57)]
		...
		{
			base.StartListening();
			AudioSourceStereoPanShakeEvent.Register(OnMMAudioSourceStereoPanShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioSourceStereoPanShakeEvent.Unregister(OnMMAudioSourceStereoPanShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioSourceStereoPanShakeEvent
	{
