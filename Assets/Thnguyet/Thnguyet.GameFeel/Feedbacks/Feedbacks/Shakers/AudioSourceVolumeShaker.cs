...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Audio/Audio Source Volume Shaker")]
	[RequireComponent(typeof(AudioSource))]
	public class AudioSourceVolumeShaker : FeelShaker
	{
		[InspectorGroup("Volume", true, 59)]
		...
		{
			base.StartListening();
			AudioSourceVolumeShakeEvent.Register(OnMMAudioSourceVolumeShakeEvent);
		}
		...
		{
			base.StopListening();
			AudioSourceVolumeShakeEvent.Unregister(OnMMAudioSourceVolumeShakeEvent);
		}
	}
	...
	/// </summary>
	public struct AudioSourceVolumeShakeEvent
	{
