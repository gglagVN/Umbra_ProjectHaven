...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Camera/Camera Clipping Planes Shaker")]
	[RequireComponent(typeof(Camera))]
	public class CameraClippingPlanesShaker : FeelShaker
	{
		[InspectorGroup("Clipping Planes", true, 31)]
		/// whether or not to add to the initial value
		[Tooltip("whether or not to add to the initial value")]
		public bool RelativeClippingPlanes = false;
        
		[InspectorGroup("Near Plane", true, 32)]
		...
		[InspectorGroup("Far Plane", true, 33)]
		/// the curve used to animate the intensity value on
		[Tooltip("the curve used to animate the intensity value on")]
		...
		{
			base.StartListening();
			CameraClippingPlanesShakeEvent.Register(OnMMCameraClippingPlanesShakeEvent);
		}
		...
		{
			base.StopListening();
			CameraClippingPlanesShakeEvent.Unregister(OnMMCameraClippingPlanesShakeEvent);
		}
	}
	...
	/// </summary>
	public struct CameraClippingPlanesShakeEvent
	{
