...
{
	/// <summary>
	/// Add this to a camera and it'll let you control its field of view over time, can be piloted by a FeedbackCameraFieldOfView
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Camera/Camera Field Of View Shaker")]
	[RequireComponent(typeof(Camera))]
	public class CameraFieldOfViewShaker : FeelShaker
	{
		[InspectorGroup("Field of View", true, 34)]
		...
		{
			base.StartListening();
			CameraFieldOfViewShakeEvent.Register(OnMMCameraFieldOfViewShakeEvent);
		}
		...
		{
			base.StopListening();
			CameraFieldOfViewShakeEvent.Unregister(OnMMCameraFieldOfViewShakeEvent);
		}
	}
	...
	/// </summary>
	public struct CameraFieldOfViewShakeEvent
	{
