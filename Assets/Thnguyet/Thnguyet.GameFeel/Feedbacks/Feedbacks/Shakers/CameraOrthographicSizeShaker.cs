...
{
	/// <summary>
	/// Add this to a camera and it'll let you control its orthographic size over time, can be piloted by a FeedbackCameraOrthographicSize
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Camera/Camera Orthographic Size Shaker")]
	[RequireComponent(typeof(Camera))]
	public class CameraOrthographicSizeShaker : FeelShaker
	{
		[InspectorGroup("Orthographic Size", true, 37)]
		...
		{
			base.StartListening();
			CameraOrthographicSizeShakeEvent.Register(OnMMCameraOrthographicSizeShakeEvent);
		}
		...
		{
			base.StopListening();
			CameraOrthographicSizeShakeEvent.Unregister(OnMMCameraOrthographicSizeShakeEvent);
		}
	}
	...
	/// </summary>
	public struct CameraOrthographicSizeShakeEvent 
	{
		...
		public delegate void Delegate(AnimationCurve animCurve, float duration, float remapMin, float remapMax, bool relativeValue = false,
			float feedbacksIntensity = 1.0f, ChannelData channelData = null, bool resetShakerValuesAfterShake = true, bool resetTargetValuesAfterShake = true, bool forwardDirection = true, 
