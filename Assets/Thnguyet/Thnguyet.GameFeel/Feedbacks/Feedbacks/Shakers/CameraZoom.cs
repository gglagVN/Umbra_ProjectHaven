...
{
	/// <summary>
	/// This class will allow you to trigger zooms on your camera by sending CameraZoomEvents from any other class
	/// </summary>
	[RequireComponent(typeof(Camera))]
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Camera/Camera Zoom")]
	public class CameraZoom : MonoBehaviour
	{
		...
		public virtual void Zoom(CameraZoomModes mode, float newFieldOfView, float transitionDuration, float duration, 
			bool useUnscaledTime, bool relative = false, TweenType tweenType = null)
		{
			if (_zooming)
			{
				return;
