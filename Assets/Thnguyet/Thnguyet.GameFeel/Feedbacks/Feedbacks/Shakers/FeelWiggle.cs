...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class WiggleProperties
	{
		...
		[Condition("ForceVectorLength", true)]
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Various/Wiggle")]
	public class FeelWiggle : MonoBehaviour 
	{
		...
		{
			returnValue.x = FeedbacksHelpers.Remap(curve.Evaluate(percent), 0f, 1f, remapMin.x, remapMax.x);
			returnValue.y = FeedbacksHelpers.Remap(curve.Evaluate(percent), 0f, 1f, remapMin.y, remapMax.y);
			returnValue.z = FeedbacksHelpers.Remap(curve.Evaluate(percent), 0f, 1f, remapMin.z, remapMax.z);
