...
{
	/// <summary>
	/// Add this to a light to have it receive LightShakeEvents from feedbacks or to shake it locally
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Lights/Light Shaker")]
	[RequireComponent(typeof(Light))]
	public class LightShaker : FeelShaker
	{
		...
		{
			base.StartListening();
			LightShakeEvent.Register(OnMMLightShakeEvent);
		}
		...
		{
			base.StopListening();
			LightShakeEvent.Unregister(OnMMLightShakeEvent);
		}
