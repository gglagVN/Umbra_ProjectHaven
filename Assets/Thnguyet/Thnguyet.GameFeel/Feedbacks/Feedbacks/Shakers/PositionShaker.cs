...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	public class PositionShaker : FeelShaker
	{
		public enum Modes { Transform, RectTransform }

		[InspectorGroup("Target", true, 41)]
		...
		[InspectorGroup("Shake Settings", true, 42)]
		...
		[InspectorGroup("Direction", true, 43)]
		...
		[Condition("RandomizeDirection", true)]
		...
		[InspectorGroup("Directional Noise", true, 47)]
		...
		[Condition("AddDirectionalNoise", true)]
		...
		[InspectorGroup("Randomness", true, 44)]
		...
		[InspectorGroup("One Time", true, 45)]
		...
		protected override void ShakeStarts()
		{
			...
			_randomizedDirection = RandomizeDirection ? FeelMaths.RandomVector3(ShakeMainDirection, ShakeAltDirection) : ShakeMainDirection;
		...
		protected virtual Vector3 ComputeNoise(float time)
		{
			...
			_randomNoiseStrength = FeelMaths.RandomVector3(DirectionalNoiseStrengthMin, DirectionalNoiseStrengthMax); 
		...
		{
			base.StartListening();
			PositionShakeEvent.Register(OnMMPositionShakeEvent);
		}
		...
		{
			base.StopListening();
			PositionShakeEvent.Unregister(OnMMPositionShakeEvent);
		}
	}
	
	public struct PositionShakeEvent
	{
