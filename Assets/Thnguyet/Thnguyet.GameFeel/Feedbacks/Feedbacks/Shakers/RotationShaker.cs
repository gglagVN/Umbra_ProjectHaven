...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	public class RotationShaker : FeelShaker
	{
		...
		{
			base.StartListening();
			RotationShakeEvent.Register(OnMMRotationShakeEvent);
		}
		...
		{
			base.StopListening();
			RotationShakeEvent.Unregister(OnMMRotationShakeEvent);
		}
	}
	
	public struct RotationShakeEvent
	{
