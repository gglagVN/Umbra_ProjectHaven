...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	public class ScaleShaker : FeelShaker
	{
		...
		{
			base.StartListening();
			ScaleShakeEvent.Register(OnMMScaleShakeEvent);
		}
		...
		{
			base.StopListening();
			ScaleShakeEvent.Unregister(OnMMScaleShakeEvent);
		}
	}
	
	public struct ScaleShakeEvent
	{
