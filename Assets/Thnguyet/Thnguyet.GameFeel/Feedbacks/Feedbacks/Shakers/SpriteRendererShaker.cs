...
{
	/// <summary>
	/// Add this to a SpriteRenderer to have it receive SpriteRendererShakeEvents from feedbacks or to shake it locally
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Renderer/Sprite Renderer Shaker")]
	[RequireComponent(typeof(SpriteRenderer))]
	public class SpriteRendererShaker : FeelShaker
	{
		[InspectorGroup("SpriteRenderer", true, 39)]
		...
		{
			base.StartListening();
			SpriteRendererShakeEvent.Register(OnMMSpriteRendererShakeEvent);
		}
		...
		{
			base.StopListening();
			SpriteRendererShakeEvent.Unregister(OnMMSpriteRendererShakeEvent);
		}

		public virtual void OnMMSpriteRendererShakeEvent(float shakeDuration, bool modifyColor, Gradient colorOverTime,
			bool flipX, bool flipY,
			float feedbacksIntensity = 1.0f, ChannelData channelData = null, bool resetShakerValuesAfterShake = true, bool resetTargetValuesAfterShake = true,
	...
	/// <summary>
	/// An event used (usually from FeeedbackSpriteRenderer) to shake the values of a SpriteRenderer
	/// </summary>
	public struct SpriteRendererShakeEvent
	{
