...
{
	/// <summary>
	/// An event used to pilot a FeelSpringColor component
	/// </summary>
	public struct SpringColorEvent
	{
		static SpringColorEvent e;
	...
	/// </summary>
	public abstract class SpringColorComponent<T> : SpringComponentBase, EventListener<SpringColorEvent> where T:Component
	{
		...
		public FeelSpringColor ColorSpring = new FeelSpringColor();
		...
		public Color TestMoveToColor = FeelColors.Aquamarine;
		...
		public Color TestBumpColor = FeelColors.Orange;
		...
		{
			Activate();
			_bumpTargetColor = _bumpTargetColor.RandomColor(BumpRandomColorMin, BumpRandomColorMax);
		...
		{
			Activate();
			_bumpTargetColor = _bumpTargetColor.RandomColor(min, max);
			Bump(_bumpTargetColor);
		}
		...
		public void OnMMEvent(SpringColorEvent springEvent)
		{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.EventStartListening<SpringColorEvent>();
		}

		protected void OnDestroy()
		{
			this.EventStopListening<SpringColorEvent>();
		}
