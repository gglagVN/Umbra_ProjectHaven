...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// </summary>
	public struct SpringFloatEvent
	{
		static SpringFloatEvent e;
	...
	/// </summary>
	public abstract class SpringFloatComponent<T> : SpringComponentBase, EventListener<SpringFloatEvent> where T:Component
	{
		...
		public SpringFloat FloatSpring = new SpringFloat();
		...
		public void OnMMEvent(SpringFloatEvent springEvent)
		{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.EventStartListening<SpringFloatEvent>();
		}

		protected void OnDestroy()
		{
			this.EventStopListening<SpringFloatEvent>();
		}
