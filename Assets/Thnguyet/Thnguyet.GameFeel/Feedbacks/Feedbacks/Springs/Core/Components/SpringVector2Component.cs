...
{
	/// <summary>
	/// An event used to pilot a SpringVector2 component
	/// </summary>
	public struct SpringVector2Event
	{
		static SpringVector2Event e;
	...
	/// </summary>
	public abstract class SpringVector2Component<T> : SpringComponentBase, EventListener<SpringVector2Event> where T:Component
	{
		...
		public void OnMMEvent(SpringVector2Event springEvent)
		{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.EventStartListening<SpringVector2Event>();
		}

		protected void OnDestroy()
		{
			this.EventStopListening<SpringVector2Event>();
		}
