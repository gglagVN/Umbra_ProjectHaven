...
{
	/// <summary>
	/// An event used to pilot a SpringVector3 component
	/// </summary>
	public struct SpringVector3Event
	{
		static SpringVector3Event e;
	...
	/// </summary>
	public abstract class SpringVector3Component<T> : SpringComponentBase, EventListener<SpringVector3Event> where T:Component
	{
		...
		public void OnMMEvent(SpringVector3Event springEvent)
		{
		...
		protected override void Awake()
		{
			...
			base.Awake();
			this.EventStartListening<SpringVector3Event>();
		}

		protected void OnDestroy()
		{
			this.EventStopListening<SpringVector3Event>();
		}
