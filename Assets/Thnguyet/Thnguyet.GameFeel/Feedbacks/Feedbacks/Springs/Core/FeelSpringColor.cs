...
{
	[Serializable]
	public class FeelSpringColor : SpringDefinition<Color>
	{
		public SpringFloat ColorSpring;
		
		public SpringFloat SpringR;
		public SpringFloat SpringG;
		public SpringFloat SpringB;
		public SpringFloat SpringA;

		protected Color _returnCurrentValue;
		protected Color _returnTargetValue;
		protected Color _returnVelocity;
		
		public FeelSpringColor()
		{
			SpringR = new SpringFloat();
			SpringG = new SpringFloat();
			SpringB = new SpringFloat();
			SpringA = new SpringFloat();
			ColorSpring = new SpringFloat();
		}
