...
{
	[Serializable]
	public class SpringFloat : SpringDefinition<float>
	{
		...
		[InspectorGroup("Debug", true, 19, true)]
		...
		public SpringDebug SpringDebug = new SpringDebug();
		...
		{
			FeelMaths.Spring(ref _actualCurrentValue, TargetValue, ref _velocity, Damping, Frequency, deltaTime);
