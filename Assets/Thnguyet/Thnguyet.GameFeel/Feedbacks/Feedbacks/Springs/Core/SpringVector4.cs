...
{
	[Serializable]
	public class SpringVector4 : SpringDefinition<Vector4>
	{
		public bool SeparateAxis = false;
		public SpringFloat UnifiedSpring;
		public SpringFloat SpringX;
		public SpringFloat SpringY;
		public SpringFloat SpringZ;
		public SpringFloat SpringW;

		protected Vector4 _returnCurrentValue;
		protected Vector4 _returnTargetValue;
		protected Vector4 _returnVelocity;
		
		public SpringVector4()
		{
			SpringX = new SpringFloat();
			SpringY = new SpringFloat();
			SpringZ = new SpringFloat();
			SpringW = new SpringFloat();
			UnifiedSpring = new SpringFloat();
