...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackSpringVector2 : FeedbackFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			SpringVector2Event.Trigger(Command, TargetSpring, _eventChannelData, MoveToValue, BumpAmount,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			_eventChannelData = (TargetSpring == null) ? ChannelData : null;
			SpringVector2Event.Trigger(SpringCommands.Stop, TargetSpring, _eventChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			_eventChannelData = (TargetSpring == null) ? ChannelData : null;
			SpringVector2Event.Trigger(SpringCommands.RestoreInitialValue, TargetSpring, _eventChannelData);
		}
	}
}