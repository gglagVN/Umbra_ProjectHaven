...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackSpringVector4 : FeedbackFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			SpringVector4Event.Trigger(Command, TargetSpring, _eventChannelData, MoveToValue, BumpAmount,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			_eventChannelData = (TargetSpring == null) ? ChannelData : null;
			SpringVector4Event.Trigger(SpringCommands.Stop, TargetSpring, _eventChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			_eventChannelData = (TargetSpring == null) ? ChannelData : null;
			SpringVector4Event.Trigger(SpringCommands.RestoreInitialValue, TargetSpring, _eventChannelData);
		}
	}
}