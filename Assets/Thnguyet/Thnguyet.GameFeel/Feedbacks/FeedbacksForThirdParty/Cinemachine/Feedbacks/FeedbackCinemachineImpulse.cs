...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackCinemachineImpulse : FeedbackFeedback
	{
		...
		#if GAMEFEEL_CINEMACHINE || GAMEFEEL_CINEMACHINE3
		[FeedbackInspectorGroup("Cinemachine Impulse", true, 28)]
		...
		public override void OnAddFeedback()
		{
			...
			this.m_ImpulseDefinition.m_RawSignal = Resources.Load<NoiseSettings>("6D_Shake");
			...
			this.m_ImpulseDefinition.RawSignal = Resources.Load<NoiseSettings>("6D_Shake");
			this.Velocity = new Vector3(5f, 5f, 5f);
			#endif
		}
		...
		public override void OnDrawGizmosSelectedHandler()
		{
			...
			#if GAMEFEEL_CINEMACHINE 
			{
				...
				{
					Gizmos.color = FeelColors.ReunoYellow;
