...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Cinemachine/Cinemachine Clipping Planes Shaker")]
	#if GAMEFEEL_CINEMACHINE
	[RequireComponent(typeof(CinemachineVirtualCamera))]
	#elif GAMEFEEL_CINEMACHINE3
	[RequireComponent(typeof(CinemachineCamera))]
	#endif
	public class CinemachineClippingPlanesShaker : FeelShaker
	{
		[InspectorGroup("Clipping Planes", true, 45)]
		/// whether or not to add to the initial value
		public bool RelativeClippingPlanes = false;

		[InspectorGroup("Near Plane", true, 46)]
		...
		[InspectorGroup("Far Plane", true, 47)]
		/// the curve used to animate the intensity value on
		[Tooltip("the curve used to animate the intensity value on")]
