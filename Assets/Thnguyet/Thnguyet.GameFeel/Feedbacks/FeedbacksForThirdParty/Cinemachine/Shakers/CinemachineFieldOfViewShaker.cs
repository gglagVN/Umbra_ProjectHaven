...
{
	/// <summary>
	/// Add this to a Cinemachine virtual camera and it'll let you control its field of view over time, can be piloted by a FeedbackCameraFieldOfView
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Cinemachine/Cinemachine Field Of View Shaker")]
	#if GAMEFEEL_CINEMACHINE
	[RequireComponent(typeof(CinemachineVirtualCamera))]
	#elif GAMEFEEL_CINEMACHINE3
	[RequireComponent(typeof(CinemachineCamera))]
	#endif
	public class CinemachineFieldOfViewShaker : FeelShaker
	{
		[InspectorGroup("Field of view", true, 41)]
