...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Cinemachine/Cinemachine Free Look Zoom")]
	#if GAMEFEEL_CINEMACHINE
	...
	public class CinemachineFreeLookZoom : MonoBehaviour
	{
		...
		public virtual void Zoom(CameraZoomModes mode, float newFieldOfView, float transitionDuration, 
			float duration, bool relative = false, TweenType tweenType = null)
		{
			if (_zooming)
			{
				return;
		...
		public virtual void OnCameraZoomEvent(CameraZoomModes mode, float newFieldOfView, float transitionDuration, float duration, 
			ChannelData channelData, bool useUnscaledTime, bool stop = false, bool relative = false, bool restore = false, TweenType tweenType = null)
		{
		...
		/// <summary>
		/// Starts listening for CameraZoomEvents
		/// </summary>
