...
{
	/// <summary>
	/// Add this to a Cinemachine virtual camera and it'll let you control its orthographic size over time, can be piloted by a FeedbackCameraOrthographicSize
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/Cinemachine/Cinemachine Orthographic Size Shaker")]
	#if GAMEFEEL_CINEMACHINE
	[RequireComponent(typeof(CinemachineVirtualCamera))]
	#elif GAMEFEEL_CINEMACHINE3
	[RequireComponent(typeof(CinemachineCamera))]
	#endif
	public class CinemachineOrthographicSizeShaker : FeelShaker
	{
		[InspectorGroup("Orthographic Size", true, 43)]
