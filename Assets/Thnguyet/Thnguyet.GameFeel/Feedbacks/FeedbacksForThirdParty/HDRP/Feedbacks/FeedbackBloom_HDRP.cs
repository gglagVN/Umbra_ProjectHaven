...
{
	/// <summary>
	/// This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume with Bloom active, and a BloomShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	[FeedbackHelp("This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume " +
	              "with Bloom active, and a BloomShaker_HDRP component.")]
	#if GAMEFEEL_HDRP
	[FeedbackPath("PostProcess/Bloom HDRP")]
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.HDRP")]
	public class FeedbackBloom_HDRP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Bloom", true, 3)]
		...
		[FeedbackInspectorGroup("Intensity", true, 4)]
		...
		[FeedbackInspectorGroup("Threshold", true, 5)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float attenuation = 1.0f)
		{
			...
			BloomShakeEvent_HDRP.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, ShakeThreshold, RemapThresholdZero, RemapThresholdOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			HDRPHelpers.GetOrCreateVolume<Bloom, BloomShaker_HDRP>(Owner, "Bloom");
			#endif
		}
	}
}