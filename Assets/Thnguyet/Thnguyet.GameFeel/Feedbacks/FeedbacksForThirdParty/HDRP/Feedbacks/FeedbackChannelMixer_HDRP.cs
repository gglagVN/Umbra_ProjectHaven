...
{	
	...
	/// with Channel Mixer active, and a ChannelMixerShaker_HDRP component.	
	/// </summary>	
	[AddComponentMenu("")]	
	[System.Serializable]
	#if GAMEFEEL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control channel mixer's red, green and blue over time." +
	              "It requires you have in your scene an object with a Volume" +
	              "with Channel Mixer active, and a Channel Mixer HDRP component.")]
	public class FeedbackChannelMixer_HDRP : FeedbackFeedback	
	{	
		...
		[FeedbackInspectorGroup("Color Grading", true, 10)]
		...
		[FeedbackInspectorGroup("Red", true, 13)]
		...
		[FeedbackInspectorGroup("Green", true, 12)]
		...
		[FeedbackInspectorGroup("Blue", true, 11)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ChannelMixerShakeEvent_HDRP.Trigger(ShakeRed, RemapRedZero, RemapRedOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			HDRPHelpers.GetOrCreateVolume<ChannelMixer, ChannelMixerShaker_HDRP>(Owner, "Channel Mixer");
			#endif
		}
	}	
}