...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Exposure active, and a ExposureShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control Exposure intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Exposure active, and a ExposureShaker_HDRP component.")]
	public class FeedbackExposure_HDRP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Exposure", true, 17)]
		...
		[FeedbackInspectorGroup("Intensity", true, 18)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ExposureShakeEvent_HDRP.Trigger(FixedExposure, FeedbackDuration, RemapFixedExposureZero, RemapFixedExposureOne, RelativeFixedExposure, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			ExposureShakeEvent_HDRP.Trigger(FixedExposure, FeedbackDuration, RemapFixedExposureZero, 
		...
		public override void AutomaticShakerSetup()
		{
			...
			HDRPHelpers.GetOrCreateVolume<Exposure, ExposureShaker_HDRP>(Owner, "Exposure");
			#endif
		}
	}
}