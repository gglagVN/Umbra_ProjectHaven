...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Lens Distortion active, and a LensDistortionShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control HDRP lens distortion intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Lens Distortion active, and a LensDistortionShaker_HDRP component.")]
	public class FeedbackLensDistortion_HDRP : FeedbackFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			LensDistortionShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			LensDistortionShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			HDRPHelpers.GetOrCreateVolume<LensDistortion, LensDistortionShaker_HDRP>(Owner, "LensDistortion");
			#endif
		}
	}
}