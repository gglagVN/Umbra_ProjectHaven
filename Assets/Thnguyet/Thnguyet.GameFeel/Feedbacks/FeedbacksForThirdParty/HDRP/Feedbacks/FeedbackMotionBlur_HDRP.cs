...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with MotionBlur active, and a MotionBlurShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_HDRP
	...
	[FeedbackHelp("This feedback allows you to control motion blur intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with MotionBlur active, and a MotionBlurShaker_HDRP component.")]
	public class FeedbackMotionBlur_HDRP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Motion Blur", true, 24)]
		...
		[FeedbackInspectorGroup("Intensity", true, 25)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MotionBlurShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MotionBlurShakeEvent_HDRP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			HDRPHelpers.GetOrCreateVolume<MotionBlur, MotionBlurShaker_HDRP>(Owner, "MotionBlur");
			#endif
		}
	}
}