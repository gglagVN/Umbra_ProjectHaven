...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with Bloom active, and a PaniniProjectionShaker_HDRP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	[FeedbackHelp("This feedback allows you to control Panini Projection distance and crop to fit over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with PaniniProjection active, and a PaniniProjectionShaker_HDRP component.")]
	#if GAMEFEEL_HDRP
	[FeedbackPath("PostProcess/Panini Projection HDRP")]
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.HDRP")]
	public class FeedbackPaniniProjection_HDRP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Panini Projection", true, 26)]
		...
		[FeedbackInspectorGroup("Distance", true, 27)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PaniniProjectionShakeEvent_HDRP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, intensityMultiplier, ChannelData, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PaniniProjectionShakeEvent_HDRP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData:ChannelData, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PaniniProjectionShakeEvent_HDRP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData:ChannelData, restore:true);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			HDRPHelpers.GetOrCreateVolume<PaniniProjection, PaniniProjectionShaker_HDRP>(Owner, "PaniniProjection");
			#endif
		}
	}
}