...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Bloom Shaker HDRP")]
	public class BloomShaker_HDRP : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Bloom Intensity", true, 42)]
		...
		[InspectorGroup("Bloom Threshold", true, 43)]
		...
		public virtual void OnBloomShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax,
			...
			float attenuation = 1.0f, ChannelData channelData = null, bool resetShakerValuesAfterShake = true, 
		...
		{
			base.StartListening();
			BloomShakeEvent_HDRP.Register(OnBloomShakeEvent);
		}
		...
		{
			base.StopListening();
			BloomShakeEvent_HDRP.Unregister(OnBloomShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct BloomShakeEvent_HDRP
	{
