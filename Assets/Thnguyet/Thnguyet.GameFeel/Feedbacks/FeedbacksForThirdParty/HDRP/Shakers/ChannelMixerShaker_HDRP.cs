...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Channel Mixer Shaker HDRP")]
	public class ChannelMixerShaker_HDRP : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Red", true, 42)]
		...
		{
			base.StartListening();
			ChannelMixerShakeEvent_HDRP.Register(OnMMChannelMixerShakeEvent);
		}
		...
		{
			base.StopListening();
			ChannelMixerShakeEvent_HDRP.Unregister(OnMMChannelMixerShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct ChannelMixerShakeEvent_HDRP
	{
