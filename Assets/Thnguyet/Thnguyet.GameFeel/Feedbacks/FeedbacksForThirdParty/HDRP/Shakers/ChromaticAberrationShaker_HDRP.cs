...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Chromatic Aberration Shaker HDRP")]
	public class ChromaticAberrationShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Chromatic Aberration Intensity", true, 44)]
		...
		{
			base.StartListening();
			ChromaticAberrationShakeEvent_HDRP.Register(OnMMChromaticAberrationShakeEvent);
		}
		...
		{
			base.StopListening();
			ChromaticAberrationShakeEvent_HDRP.Unregister(OnMMChromaticAberrationShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct ChromaticAberrationShakeEvent_HDRP
	{
