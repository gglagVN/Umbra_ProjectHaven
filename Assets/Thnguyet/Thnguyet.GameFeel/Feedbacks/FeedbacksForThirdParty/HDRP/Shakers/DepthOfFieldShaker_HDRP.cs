...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Depth Of Field Shaker HDRP")]
	public class DepthOfFieldShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Focus Distance", true, 53)]
		...
		[Condition("AnimateFocusDistance", true)]
		...
		[InspectorGroup("Near Range", true, 52)]
		...
		[Condition("AnimateNearRangeStart", true)]
		...
		[Condition("AnimateNearRangeEnd", true)]
		...
		[InspectorGroup("Far Range", true, 51)]
		...
		[Condition("AnimateFarRangeStart", true)]
		...
		[Condition("AnimateFarRangeEnd", true)]
		...
		{
			base.StartListening();
			DepthOfFieldShakeEvent_HDRP.Register(OnDepthOfFieldShakeEvent);
		}
		...
		{
			base.StopListening();
			DepthOfFieldShakeEvent_HDRP.Unregister(OnDepthOfFieldShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct DepthOfFieldShakeEvent_HDRP
	{
