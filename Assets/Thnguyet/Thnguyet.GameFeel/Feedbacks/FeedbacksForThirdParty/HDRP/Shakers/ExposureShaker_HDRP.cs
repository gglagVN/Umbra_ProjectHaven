...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Exposure Shaker HDRP")]
	public class ExposureShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Exposure Intensity", true, 46)]
		...
		{
			base.StartListening();
			ExposureShakeEvent_HDRP.Register(OnExposureShakeEvent);
		}
		...
		{
			base.StopListening();
			ExposureShakeEvent_HDRP.Unregister(OnExposureShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct ExposureShakeEvent_HDRP
	{
