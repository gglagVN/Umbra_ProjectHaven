...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Film Grain Shaker HDRP")]
	public class FilmGrainShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Film Grain Intensity", true, 47)]
		...
		{
			base.StartListening();
			FilmGrainShakeEvent_HDRP.Register(OnFilmGrainShakeEvent);
		}
		...
		{
			base.StopListening();
			FilmGrainShakeEvent_HDRP.Unregister(OnFilmGrainShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct FilmGrainShakeEvent_HDRP
	{
