...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Lens Distortion Shaker HDRP")]
	public class LensDistortionShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Lens Distortion Intensity", true, 47)]
		...
		{
			base.StartListening();
			LensDistortionShakeEvent_HDRP.Register(OnMMLensDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			LensDistortionShakeEvent_HDRP.Unregister(OnMMLensDistortionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct LensDistortionShakeEvent_HDRP
	{
