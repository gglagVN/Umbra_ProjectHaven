...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Motion Blur Shaker HDRP")]
	public class MotionBlurShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Motion Blur Intensity", true, 48)]
		...
		{
			base.StartListening();
			MotionBlurShakeEvent_HDRP.Register(OnMotionBlurShakeEvent);
		}
		...
		{
			base.StopListening();
			MotionBlurShakeEvent_HDRP.Unregister(OnMotionBlurShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct MotionBlurShakeEvent_HDRP
	{
