...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Panini Projection Shaker HDRP")]
	public class PaniniProjectionShaker_HDRP : FeelShaker
	{
		[InspectorGroup("Panini Projection Distance", true, 49)]
		...
		{
			base.StartListening();
			PaniniProjectionShakeEvent_HDRP.Register(OnPaniniProjectionShakeEvent);
		}
		...
		{
			base.StopListening();
			PaniniProjectionShakeEvent_HDRP.Unregister(OnPaniniProjectionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PaniniProjectionShakeEvent_HDRP
	{
