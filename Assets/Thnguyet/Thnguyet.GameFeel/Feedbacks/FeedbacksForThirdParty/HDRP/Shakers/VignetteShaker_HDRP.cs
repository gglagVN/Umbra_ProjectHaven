...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Vignette Shaker HDRP")]
	public class VignetteShaker_HDRP : FeelShaker
	{
		[Header("Intensity")]
		[InspectorGroup("Vignette Intensity", true, 46)]
		...
		{
			base.StartListening();
			VignetteShakeEvent_HDRP.Register(OnVignetteShakeEvent);
		}
		...
		{
			base.StopListening();
			VignetteShakeEvent_HDRP.Unregister(OnVignetteShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct VignetteShakeEvent_HDRP
	{
