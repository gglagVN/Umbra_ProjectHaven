...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/White Balance Shaker HDRP")]
	public class WhiteBalanceShaker_HDRP : FeelShaker
	{
		/// whether or not to add to the initial value
		[Tooltip("whether or not to add to the initial value")]
		public bool RelativeValues = true;

		[InspectorGroup("Temperature", true, 47)]
		...
		{
			base.StartListening();
			WhiteBalanceShakeEvent_HDRP.Register(OnWhiteBalanceShakeEvent);
		}
		...
		{
			base.StopListening();
			WhiteBalanceShakeEvent_HDRP.Unregister(OnWhiteBalanceShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct WhiteBalanceShakeEvent_HDRP
	{
