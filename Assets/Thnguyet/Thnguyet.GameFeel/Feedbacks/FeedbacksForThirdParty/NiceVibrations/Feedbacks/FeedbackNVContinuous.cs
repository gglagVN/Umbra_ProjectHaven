...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackNVContinuous : FeedbackFeedback
	{
		#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
		...
		[FeedbackInspectorGroup("Haptic Amplitude", true, 31)]
		...
		[FeedbackInspectorGroup("Haptic Frequency", true, 32)]
		...
		[FeedbackInspectorGroup("Duration", true, 33)]
		...
		[FeedbackInspectorGroup("Real-time Modulation", true, 34)]
		...
		[FeedbackCondition("UseRealTimeModulation", true)]
