...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackNVControl : FeedbackFeedback
	{
		#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
		...
		[FeedbackInspectorGroup("Haptic Control", true, 24)]
		...
		[FeedbackEnumCondition("ControlType", (int)ControlTypes.AdjustHapticsLevel)]
