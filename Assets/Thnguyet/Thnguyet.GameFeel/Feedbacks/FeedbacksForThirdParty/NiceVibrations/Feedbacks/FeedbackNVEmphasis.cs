...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackNVEmphasis : FeedbackFeedback
	{
		#if MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED
		...
		[FeedbackInspectorGroup("Haptic Amplitude", true, 23)]
		...
		[FeedbackInspectorGroup("Haptic Frequency", true, 22)]
		...
		public FeedbackButton PlayEmphasisButton;
		...
		public override void InitializeCustomAttributes()
		{
			...
			PlayEmphasisButton = new FeedbackButton("Test Emphasis", PlayEmphasis);
		}
