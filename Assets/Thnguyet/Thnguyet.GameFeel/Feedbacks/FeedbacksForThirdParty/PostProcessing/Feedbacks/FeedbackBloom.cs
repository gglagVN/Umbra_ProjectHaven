...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Bloom active, and a BloomShaker component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	...
	public class FeedbackBloom : FeedbackFeedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			BloomShakeEvent.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, ShakeThreshold, RemapThresholdZero, RemapThresholdOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			PostProcessingHelpers.GetOrCreateVolume<Bloom, BloomShaker>(Owner, "Bloom");
			#endif
		}
	}
}