...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Chromatic Aberration active, and a ChromaticAberrationShaker component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_POSTPROCESSING
	...
	[FeedbackHelp("This feedback allows you to control chromatic aberration intensity over time. It requires you have in your scene an object with a PostProcessVolume " +
	              "with Chromatic Aberration active, and a ChromaticAberrationShaker component.")]
	public class FeedbackChromaticAberration : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Chromatic Aberration", true, 44)]
		...
		[FeedbackInspectorGroup("Intensity", true, 45)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ChromaticAberrationShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			ChromaticAberrationShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			ChromaticAberrationShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			PostProcessingHelpers.GetOrCreateVolume<ChromaticAberration, ChromaticAberrationShaker>(Owner, "Chromatic Aberration");
			#endif
		}
	}
}