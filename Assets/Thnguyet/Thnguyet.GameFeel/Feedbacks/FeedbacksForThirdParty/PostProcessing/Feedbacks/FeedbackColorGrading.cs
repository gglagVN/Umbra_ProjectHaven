...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Color Grading active, and a ColorGradingShaker component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_POSTPROCESSING
	...
	[FeedbackHelp("This feedback allows you to control color grading post exposure, hue shift, saturation and contrast over time. " +
	              "It requires you have in your scene an object with a PostProcessVolume " +
	              "with Color Grading active, and a ColorGradingShaker component.")]
	public class FeedbackColorGrading : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Color Grading", true, 46)]
		...
		[FeedbackInspectorGroup("Post Exposure", true, 47)]
		...
		[FeedbackInspectorGroup("Hue Shift", true, 48)]
		...
		[FeedbackInspectorGroup("Saturation", true, 49)]
		...
		[FeedbackInspectorGroup("Contrast", true, 50)]
		/// the curve used to animate the focal length value on
		[Tooltip("the curve used to animate the focal length value on")]
		...
		[FeedbackInspectorGroup("Color Filter", true, 50)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ColorGradingShakeEvent.Trigger(ShakePostExposure, RemapPostExposureZero, RemapPostExposureOne, 
		...
		public override void AutomaticShakerSetup()
		{
			...
			PostProcessingHelpers.GetOrCreateVolume<ColorGrading, ColorGradingShaker>(Owner, "Color Grading");
			#endif
		}
	}
}