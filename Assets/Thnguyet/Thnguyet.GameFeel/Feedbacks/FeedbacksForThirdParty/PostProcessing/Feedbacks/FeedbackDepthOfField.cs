...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Depth of Field active, and a DepthOfFieldShaker component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	...
	public class FeedbackDepthOfField : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Depth Of Field", true, 51)]
		...
		[FeedbackInspectorGroup("Focus Distance", true, 52)]
		...
		[FeedbackInspectorGroup("Aperture", true, 53)]
		...
		[FeedbackInspectorGroup("Focal Length", true, 54)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			DepthOfFieldShakeEvent.Trigger(ShakeFocusDistance, FeedbackDuration, RemapFocusDistanceZero, RemapFocusDistanceOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			PostProcessingHelpers.GetOrCreateVolume<DepthOfField, DepthOfFieldShaker>(Owner, "DepthOfField");
			#endif
		}
	}
}