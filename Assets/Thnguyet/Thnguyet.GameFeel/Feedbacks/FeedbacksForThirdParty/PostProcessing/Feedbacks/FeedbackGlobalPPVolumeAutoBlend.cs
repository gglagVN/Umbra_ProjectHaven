...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.PostProcessing")]
	public class FeedbackGlobalPPVolumeAutoBlend : FeedbackFeedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetAutoBlend = FindAutomatedTarget<GlobalPostProcessingVolumeAutoBlend>();
		...
		[FeedbackInspectorGroup("PostProcess Volume Blend", true, 53, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Default)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Override)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			#if GAMEFEEL_POSTPROCESSING
			GlobalPostProcessingVolumeAutoBlend.TimeScales timeScale = (ComputedTimescaleMode == TimescaleModes.Scaled) ? GlobalPostProcessingVolumeAutoBlend.TimeScales.Scaled : GlobalPostProcessingVolumeAutoBlend.TimeScales.Unscaled;
			PostProcessingVolumeAutoBlendShakeEvent.Trigger(ChannelData, TargetAutoBlend, Mode, BlendAction, ApplyTimeMultiplier(BlendDuration), BlendCurve, InitialWeight, FinalWeight, ResetToInitialValueOnEnd, NormalPlayDirection, timeScale);
			#endif
		}
