...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Lens Distortion active, and a LensDistortionShaker component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_POSTPROCESSING
	...
	[FeedbackHelp("This feedback allows you to control lens distortion intensity over time. " +
	              "It requires you have in your scene an object with a PostProcessVolume " +
	              "with Lens Distortion active, and a LensDistortionShaker component.")]
	public class FeedbackLensDistortion : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Lens Distortion", true, 56)]
		...
		[FeedbackInspectorGroup("Intensity", true, 57)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			LensDistortionShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			LensDistortionShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			LensDistortionShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			PostProcessingHelpers.GetOrCreateVolume<LensDistortion, LensDistortionShaker>(Owner, "Lens Distortion");
			#endif
		}
	}
}