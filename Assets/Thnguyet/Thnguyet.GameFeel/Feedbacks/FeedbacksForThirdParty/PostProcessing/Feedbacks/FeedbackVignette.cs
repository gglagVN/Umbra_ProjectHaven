...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Vignette active, and a VignetteShaker component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_POSTPROCESSING
	...
	[FeedbackHelp("This feedback allows you to control vignette intensity over time. " +
	              "It requires you have in your scene an object with a PostProcessVolume " +
	              "with Vignette active, and a VignetteShaker component.")]
	public class FeedbackVignette : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Vignette", true, 58)]
		...
		[FeedbackInspectorGroup("Intensity", true, 59)]
		...
		[FeedbackInspectorGroup("Vignette Color", true, 60)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			VignetteShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			VignetteShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			VignetteShakeEvent.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			PostProcessingHelpers.GetOrCreateVolume<Vignette, VignetteShaker>(Owner, "Vignette");
			#endif
		}
	}
}