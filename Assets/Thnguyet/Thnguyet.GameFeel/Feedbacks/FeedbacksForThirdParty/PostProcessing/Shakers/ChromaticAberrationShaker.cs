...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Chromatic Aberration Shaker")]
	#if GAMEFEEL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class ChromaticAberrationShaker : FeelShaker
	{
		[InspectorGroup("Chromatic Aberration Intensity", true, 46)]
		...
		{
			base.StartListening();
			ChromaticAberrationShakeEvent.Register(OnMMChromaticAberrationShakeEvent);
		}
		...
		{
			base.StopListening();
			ChromaticAberrationShakeEvent.Unregister(OnMMChromaticAberrationShakeEvent);
		}
		#endif
	}
