...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Color Grading Shaker")]
	#if GAMEFEEL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class ColorGradingShaker : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Post Exposure", true, 40)]
		...
		[InspectorGroup("Hue Shift", true, 49)]
		...
		[InspectorGroup("Saturation", true, 48)]
		...
		{
			base.StartListening();
			ColorGradingShakeEvent.Register(OnMMColorGradingShakeEvent);
		}
		...
		{
			base.StopListening();
			ColorGradingShakeEvent.Unregister(OnMMColorGradingShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct ColorGradingShakeEvent
	{
