...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Depth Of Field Shaker")]
	#if GAMEFEEL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class DepthOfFieldShaker : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Focus Distance", true, 49)]
		...
		[InspectorGroup("Aperture", true, 50)]
		...
		[InspectorGroup("Focal Length", true, 51)]
		...
		{
			base.StartListening();
			DepthOfFieldShakeEvent.Register(OnDepthOfFieldShakeEvent);
		}
		...
		{
			base.StopListening();
			DepthOfFieldShakeEvent.Unregister(OnDepthOfFieldShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct DepthOfFieldShakeEvent
	{
