...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Lens Distortion Shaker")]
	#if GAMEFEEL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class LensDistortionShaker : FeelShaker
	{
		...
		{
			base.StartListening();
			LensDistortionShakeEvent.Register(OnMMLensDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			LensDistortionShakeEvent.Unregister(OnMMLensDistortionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct LensDistortionShakeEvent
	{
