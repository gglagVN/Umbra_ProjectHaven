...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Vignette Shaker")]
	#if GAMEFEEL_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
	#endif
	public class VignetteShaker : FeelShaker
	{
		[InspectorGroup("Vignette Intensity", true, 53)]
		...
		[InspectorGroup("Vignette Color", true, 51)]
		...
		{
			base.StartListening();
			VignetteShakeEvent.Register(OnVignetteShakeEvent);
		}
		...
		{
			base.StopListening();
			VignetteShakeEvent.Unregister(OnVignetteShakeEvent);
		}
		#endif
	}
