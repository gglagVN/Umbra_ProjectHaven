...
{
	[AddComponentMenu("Thnguyet/GameFeel/Springs/Spring Color Grading Temperature")]
	public class SpringColorGradingTemperature : SpringFloatComponent<PostProcessVolume>
	{
