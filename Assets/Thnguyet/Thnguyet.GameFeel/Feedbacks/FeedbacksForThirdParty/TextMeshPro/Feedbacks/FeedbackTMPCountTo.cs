...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTMPCountTo : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("TextMeshPro Target Text", true, 12, true)]
		...
		[FeedbackInspectorGroup("Count Settings", true, 13)]
		...
		public TweenType CountingCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1f)));
		...
		protected virtual float ProcessCount()
		{
			...
			float currentValue = FeelTween.Tween(currentTime, 0f, Duration, CountFrom, CountTo, CountingCurve);
			return currentValue;
		}
