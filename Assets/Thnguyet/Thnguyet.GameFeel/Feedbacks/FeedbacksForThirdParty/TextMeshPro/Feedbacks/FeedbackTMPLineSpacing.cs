...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTMPLineSpacing : FeedbackFeedbackBase
	{
		...
		[FeedbackInspectorGroup("Paragraph Spacing", true, 37)]
		/// the curve to tween on
		[Tooltip("the curve to tween on")]
		[FeedbackEnumCondition("Mode", (int)FeedbackBase.Modes.OverTime, (int)Modes.ToDestination)]
		public TweenType LineSpacingCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
