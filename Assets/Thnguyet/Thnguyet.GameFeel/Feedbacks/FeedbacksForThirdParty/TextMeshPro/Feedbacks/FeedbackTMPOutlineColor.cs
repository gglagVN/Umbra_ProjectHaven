...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTMPOutlineColor : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Outline Color", true, 16)]
		...
		[FeedbackEnumCondition("ColorMode", (int)ColorModes.Interpolate, (int)ColorModes.Gradient)]
		public float Duration = 0.2f;
		/// the color to apply
		[Tooltip("the color to apply")]
		[FeedbackEnumCondition("ColorMode", (int)ColorModes.Instant)]
		...
		[FeedbackEnumCondition("ColorMode", (int)ColorModes.Gradient)]
		[GradientUsage(true)]
		public Gradient ColorGradient;
		/// the destination color when in interpolate mode
		[Tooltip("the destination color when in interpolate mode")]
		[FeedbackEnumCondition("ColorMode", (int)ColorModes.Interpolate)]
