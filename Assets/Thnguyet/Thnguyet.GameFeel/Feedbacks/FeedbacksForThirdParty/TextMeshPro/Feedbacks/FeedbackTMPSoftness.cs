...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTMPSoftness : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Softness", true, 13)]
		...
		public TweenType SoftnessCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0f), new Keyframe(0.3f, 1f), new Keyframe(1, 0f)), "", "Mode", (int)FeedbackBase.Modes.OverTime);
		...
		{
			#if GAMEFEEL_UGUI2
			float intensity = FeelTween.Tween(time, 0f, 1f, RemapZero, RemapOne, SoftnessCurve);
		...
		public override void OnValidate()
		{
			...
			if (string.IsNullOrEmpty(SoftnessCurve.EnumConditionPropertyName))
			{
				...
				SoftnessCurve.EnumConditions[(int)FeedbackBase.Modes.OverTime] = true;
			}
		}
	}
}