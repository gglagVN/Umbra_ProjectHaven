...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackTMPTextReveal : FeedbackFeedback
	{
		...
		public override float FeedbackDuration
		{
			get
			{
				...
				else
				{
					...
					{
						List<Transform> disabledParents = TargetTMPText.transform.EnumerateAllParents(true).Where(p => !p.gameObject.activeSelf).ToList();
		...
		[FeedbackInspectorGroup("Change Text", true, 13)]
		...
		[FeedbackInspectorGroup("Reveal", true, 14)]
		...
		[FeedbackEnumCondition("DurationMode", (int)DurationModes.Interval)]
		...
		[FeedbackEnumCondition("DurationMode", (int)DurationModes.TotalDuration)]
