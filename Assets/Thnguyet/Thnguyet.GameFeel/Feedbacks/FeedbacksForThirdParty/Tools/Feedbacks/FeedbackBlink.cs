...
{
	/// <summary>
	/// This feedback will trigger a FeelBlink object, letting you blink something
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback lets you trigger a blink on an FeelBlink object.")]
	[System.Serializable]
	[FeedbackPath("Renderer/FeelBlink")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.Tools")]
	public class FeedbackBlink : FeedbackFeedback
	{
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor { get => FeedbacksInspectorColors.RendererColor; }
		...
		protected override void AutomateTargetAcquisition() => TargetBlink = FindAutomatedTarget<FeelBlink>();
        
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;

		/// the possible modes for this feedback, that correspond to FeelBlink's public methods
		public enum BlinkModes { Toggle, Start, Stop }
        
		[FeedbackInspectorGroup("Blink", true, 61, true)]
		/// the target object to blink
		[Tooltip("the target object to blink")]
		public FeelBlink TargetBlink;
		/// an optional list of extra target objects to blink
		[Tooltip("an optional list of extra target objects to blink")]
		public List<FeelBlink> ExtraTargetBlinks;
		...
		public FeedbackButton GrabDurationFromBlinkButton;
		...
		{
			GrabDurationFromBlinkButton = new FeedbackButton("Grab Duration From Blink Component", GrabDurationFromBlink);
		}

		/// <summary>
		/// On Custom play, we trigger our FeelBlink object
		/// </summary>
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			foreach (FeelBlink blink in ExtraTargetBlinks)
			{
				HandleBlink(blink);
			}
		}
		...
		protected virtual void HandleBlink(FeelBlink target)
		{
