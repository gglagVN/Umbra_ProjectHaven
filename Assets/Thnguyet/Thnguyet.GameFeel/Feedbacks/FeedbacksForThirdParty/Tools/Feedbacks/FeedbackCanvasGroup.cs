...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackCanvasGroup : FeedbackFeedbackBase
	{
		...
		[FeedbackInspectorGroup("Canvas Group", true, 12, true)]
		...
		public TweenType AlphaCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
