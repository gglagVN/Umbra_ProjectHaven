...
{
	/// <summary>
	/// This feedback doesn't do anything by default, it's just meant as a comment, you can store text in it for future reference, maybe to remember how you setup a particular FeelFeedbacks. Optionally it can also output that comment to the console on Play.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback doesn't do anything by default, it's just meant as a comment, you can store text in it for future reference, maybe to remember how you setup a particular FeelFeedbacks. Optionally it can also output that comment to the console on Play.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.Tools")]
	[System.Serializable]
	[FeedbackPath("Debug/Comment")]
	public class FeedbackDebugComment : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Comment", true, 61)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			FeelDebug.DebugLogInfo(Comment);
		}
	}
}
