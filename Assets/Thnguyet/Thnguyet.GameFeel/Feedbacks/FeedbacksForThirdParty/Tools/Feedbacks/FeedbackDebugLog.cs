...
{
	/// <summary>
	/// This feedback will let you output a message to the console, using a custom Feel debug method, or Log, Assertion, Error or Warning logs.
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("This feedback will let you output a message to the console, using a custom Feel debug method, or Log, Assertion, Error or Warning logs.")]
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.Tools")]
	[System.Serializable]
	[FeedbackPath("Debug/Log")]
	public class FeedbackDebugLog : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Debug", true, 17)]
		...
		[FeedbackEnumCondition("DebugLogMode", (int) DebugLogModes.DebugLogTime)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (DebugLogMode)
			{
				...
				case DebugLogModes.DebugLogTime:
					...
					FeelDebug.DebugLogTime(DebugMessage, color, 3, DisplayFrameCount);
					break;
			}
		}
	}
