...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	/// This requires that a FloatingTextSpawner be correctly setup in the scene, otherwise nothing will happen.
	/// To do so, create a new empty object, add a FloatingTextSpawner to it. Drag (at least) one FeelFloatingText prefab into its PooledSimpleMMFloatingText slot.
	/// You'll find such prefabs already made in the Tools/Tools/FeelFloatingText/Prefabs folder, but feel free to create your own.
	...
	public class FeedbackFloatingText : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Floating Text", true, 64)]
		...
		[FeedbackInspectorGroup("Rounding", true, 68)]
		public RoundingMethods RoundingMethod = RoundingMethods.NoRounding;

		[FeedbackInspectorGroup("Color", true, 65)]
		...
		[FeedbackInspectorGroup("Lifetime", true, 66)]
		...
		[FeedbackCondition("ForceLifetime", true)]
		public float Lifetime = 0.5f;

		[FeedbackInspectorGroup("Position", true, 67)]
		...
		[FeedbackEnumCondition("PositionMode", (int)PositionModes.TargetTransform)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			FloatingTextSpawnEvent.Trigger(ChannelData, _playPosition, _value, Direction, Intensity * intensityMultiplier, ForceLifetime, Lifetime, ForceColor, AnimateColorGradient, 
