...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackImageAlpha : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Target Image", true, 12, true)]
		...
		[FeedbackInspectorGroup("Image Alpha Animation", true, 24)]
		...
		public TweenType Curve = new TweenType(FeelTween.TweenCurve.EaseInCubic, "", "Mode", (int)Modes.OverTime, (int)Modes.ToDestination);
