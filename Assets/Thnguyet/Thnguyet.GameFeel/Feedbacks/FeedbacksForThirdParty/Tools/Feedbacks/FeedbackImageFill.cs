...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackImageFill : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Image Fill Animation", true, 24)]
		...
		protected virtual void SetFill(float time)
		{
			...
			{
				newFill = FeelTween.Tween(time, 0f, 1f, CurveRemapZero, CurveRemapOne, Curve);    
			}
			else if (Mode == Modes.ToDestination)
			{
				newFill = FeelTween.Tween(time, 0f, 1f, _initialFill, DestinationFill, Curve);
			}
