...
{
	/// <summary>
	/// A scriptable object used to store data for FeelSoundManager play
	/// </summary>
	[Serializable]
	[CreateAssetMenu(menuName = "Thnguyet/GameFeel/Audio/FeedbackSoundData")]
	public class FeedbackMMSoundManagerSoundData : ScriptableObject
	{
		[Header("Sound")]
		...
		[Condition("UseCustomRolloffCurve", true)]
		...
		[Condition("UseSpatialBlendCurve", true)]
		...
		[Condition("UseReverbZoneMixCurve", true)]
		...
		[Condition("UseSpreadCurve", true)]
		public AnimationCurve SpreadCurve;
		
		[InspectorButton("TestPlaySound")]
