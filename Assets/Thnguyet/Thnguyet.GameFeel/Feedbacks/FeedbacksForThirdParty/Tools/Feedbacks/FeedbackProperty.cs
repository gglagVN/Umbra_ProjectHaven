...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackProperty : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Level", true, 30)]
		/// the curve to tween the intensity on
		[Tooltip("the curve to tween the intensity on")]
		public TweenType LevelCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)), "", "Mode", (int)Modes.OverTime, (int)Modes.ToDestination);
		...
		{
			float intensity = FeelTween.Tween(time, 0f, 1f, remapZero, remapOne, LevelCurve);
