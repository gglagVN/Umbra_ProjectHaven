...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackRectTransformOffset : FeedbackFeedbackBase
	{
		...
		[FeedbackInspectorGroup("Offset Min", true, 40)] 
		...
		public TweenType OffsetMinCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1)));
		...
		[FeedbackInspectorGroup("Offset Max", true, 41)] 
		...
		[FeedbackEnumCondition("Mode", (int)FeedbackBase.Modes.OverTime)]
		public TweenType OffsetMaxCurve = new TweenType(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1)));
