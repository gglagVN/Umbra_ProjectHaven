...
namespace Thnguyet.GameFeel.Feedbacks
{
	...
	public class FeedbackShaderController : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Shader Controller", true, 37, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OneTime)]
