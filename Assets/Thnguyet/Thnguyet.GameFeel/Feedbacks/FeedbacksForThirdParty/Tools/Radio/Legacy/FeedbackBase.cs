...
{
	public class FeedbackBaseTarget
	{
	...
	public abstract class FeedbackBase : FeelFeedback
	{
		...
		protected List<FeedbackBaseTarget> _targets;
		...
		{
			_targets = new List<FeedbackBaseTarget>();
			FillTargets();
			InitializeTargets();
		}
		...
		protected virtual void InitializeTargets()
		{
			...
			foreach(FeedbackBaseTarget target in _targets)
			{
