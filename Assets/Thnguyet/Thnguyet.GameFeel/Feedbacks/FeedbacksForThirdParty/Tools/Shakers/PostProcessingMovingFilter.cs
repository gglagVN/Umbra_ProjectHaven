...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	public struct PostProcessingMovingFilterEvent
	{
		...
		public delegate void Delegate(TweenType curve, bool active, bool toggle, float duration, int channel = 0,
			bool stop = false, bool restore = false);

		static public void Trigger(TweenType curve, bool active, bool toggle, float duration, int channel = 0,
			bool stop = false, bool restore = false)
		{
	...
	/// Typically a moving filter should be made of a PostProcessingMovingFilter component, 
	...
	/// 
	/// Use : 
	/// PostProcessingMovingFilterEvent.Trigger(FeelTween.TweenCurve.EaseInOutCubic, TrueOrFalse, Duration, ChannelID);
	/// 
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Camera/Post Processing Moving Filter")]
	public class PostProcessingMovingFilter : MonoBehaviour
	{
		...
		public TweenType Curve = new TweenType(FeelTween.TweenCurve.EaseInCubic);
		...
		[InspectorButton("PostProcessingToggle")]
		...
		protected virtual void MoveTowardsCurrentTarget()
		{
			...
			_newPosition.y =
				FeelTween.Tween(currentTime - _lastMovementStartedAt, 0f, _duration, originY, targetY, Curve);
		...
		public virtual void OnMMPostProcessingMovingFilterEvent(TweenType curve, bool active, bool toggle,
		...
		/// <summary>
		/// On enable, we start listening to PostProcessingTriggerEvents
		/// </summary>
		protected virtual void OnEnable()
		{
			PostProcessingMovingFilterEvent.Register(OnMMPostProcessingMovingFilterEvent);
		}

		/// <summary>
		/// On disable, we stop listening to PostProcessingTriggerEvents
		/// </summary>
		protected virtual void OnDisable()
		{
			PostProcessingMovingFilterEvent.Unregister(OnMMPostProcessingMovingFilterEvent);
		}
		...
		{
			PostProcessingMovingFilterEvent.Trigger(new TweenType(FeelTween.TweenCurve.EaseInOutCubic), false, true,
				TestDuration, 0);
		}
		...
		{
			PostProcessingMovingFilterEvent.Trigger(new TweenType(FeelTween.TweenCurve.EaseInOutCubic), false,
		...
		{
			PostProcessingMovingFilterEvent.Trigger(new TweenType(FeelTween.TweenCurve.EaseInOutCubic), true, false,
				TestDuration, 0);
		}
	}
}