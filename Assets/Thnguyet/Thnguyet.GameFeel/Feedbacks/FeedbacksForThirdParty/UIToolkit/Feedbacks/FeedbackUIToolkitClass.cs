...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackUIToolkitClass : FeedbackUIToolkit
	{
		...
		[FeedbackEnumCondition("Mode", (int)Modes.AddToClassList, (int)Modes.EnableInClassList, (int)Modes.ToggleInClassList, (int)Modes.RemoveFromClassList)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.EnableInClassList)]
