...
{
	/// <summary>
	/// This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume with Bloom active, and a BloomShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	[FeedbackHelp("This feedback allows you to control bloom intensity and threshold over time. It requires you have in your scene an object with a Volume " +
	              "with Bloom active, and a BloomShaker_URP component.")]
	#if GAMEFEEL_URP
	[FeedbackPath("PostProcess/Bloom URP")]
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.URP")]
	public class FeedbackBloom_URP : FeedbackFeedback 
	{
		...
		[FeedbackInspectorGroup("Bloom", true, 41)]
		...
		[FeedbackInspectorGroup("Intensity", true, 42)]
		...
		[FeedbackInspectorGroup("Threshold", true, 43)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float attenuation = 1.0f)
		{
			...
			BloomShakeEvent_URP.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, ShakeThreshold, RemapThresholdZero, RemapThresholdOne,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			BloomShakeEvent_URP.Trigger(ShakeIntensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, 
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<Bloom, BloomShaker_URP>(Owner, "Bloom");
			#endif
		}
	}
}