...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackChannelMixer_URP : FeedbackFeedback 
	{
		...
		[FeedbackInspectorGroup("Channel Mixer", true, 41)]
		...
		[FeedbackInspectorGroup("Red", true, 42)]
		...
		[FeedbackInspectorGroup("Green", true, 43)]
		...
		[FeedbackInspectorGroup("Blue", true, 44)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ChannelMixerShakeEvent_URP.Trigger(ShakeRed, RemapRedZero, RemapRedOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<ChannelMixer, ChannelMixerShaker_URP>(Owner, "Channel Mixer");
			#endif
		}
	}
}