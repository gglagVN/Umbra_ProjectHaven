...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Color Adjustments active, and a ColorAdjustmentsShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	...
	public class FeedbackColorAdjustments_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Color Grading", true, 43)]
		...
		[FeedbackInspectorGroup("Post Exposure", true, 48)]
		...
		[FeedbackInspectorGroup("Hue Shift", true, 47)]
		...
		[FeedbackInspectorGroup("Saturation", true, 46)]
		...
		[FeedbackInspectorGroup("Contrast", true, 45)]
		/// the curve used to animate the focal length value on
		[Tooltip("the curve used to animate the focal length value on")]
		...
		[FeedbackInspectorGroup("Color Filter", true, 44)]
		...
		[Tooltip("the selected color filter mode :" +
		         ...
		         "gradient : evaluates the color over time on that gradient, from left to right," +
		         "interpolate : lerps from the current color to the destination one ")]
		public ColorAdjustmentsShaker_URP.ColorFilterModes ColorFilterMode = ColorAdjustmentsShaker_URP.ColorFilterModes.None;
		...
		[FeedbackEnumCondition("ColorFilterMode", (int)ColorAdjustmentsShaker_URP.ColorFilterModes.Gradient)]
		[GradientUsage(true)]
		...
		[FeedbackEnumCondition("ColorFilterMode", (int) ColorAdjustmentsShaker_URP.ColorFilterModes.Interpolate)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ColorAdjustmentsShakeEvent_URP.Trigger(ShakePostExposure, RemapPostExposureZero, RemapPostExposureOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<ColorAdjustments, ColorAdjustmentsShaker_URP>(Owner, "ColorAdjustments");
			#endif
		}
	}
}