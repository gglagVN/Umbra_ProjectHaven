...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Depth of Field active, and a DepthOfFieldShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	...
	public class FeedbackDepthOfField_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Depth Of Field", true, 49)]
		...
		[FeedbackInspectorGroup("Focus Distance", true, 50)]
		...
		[FeedbackInspectorGroup("Aperture", true, 51)]
		...
		[FeedbackInspectorGroup("Focal Length", true, 20)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			DepthOfFieldShakeEvent_URP.Trigger(ShakeFocusDistance, FeedbackDuration, RemapFocusDistanceZero, RemapFocusDistanceOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<DepthOfField, DepthOfFieldShaker_URP>(Owner, "DepthOfField");
			#endif
		}
	}
}