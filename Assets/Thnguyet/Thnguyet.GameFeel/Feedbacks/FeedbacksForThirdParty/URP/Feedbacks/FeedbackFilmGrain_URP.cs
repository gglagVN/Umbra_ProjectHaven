...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Film Grain active, and a FilmGrainShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_URP
	...
	[FeedbackHelp("This feedback allows you to control Film Grain intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Film Grain active, and a FilmGrainShaker_URP component.")]
	public class FeedbackFilmGrain_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Film Grain", true, 21)]
		...
		[FeedbackInspectorGroup("Intensity", true, 22)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			FilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			FilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true, channelData: ChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			FilmGrainShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true, channelData: ChannelData);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<FilmGrain, FilmGrainShaker_URP>(Owner, "FilmGrain");
			#endif
		}
	}
}