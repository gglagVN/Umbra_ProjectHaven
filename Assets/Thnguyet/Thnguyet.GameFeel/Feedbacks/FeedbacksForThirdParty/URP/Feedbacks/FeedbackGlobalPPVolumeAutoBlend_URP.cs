...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackGlobalPPVolumeAutoBlend_URP : FeedbackFeedback
	{
		...
		protected override void AutomateTargetAcquisition() => TargetAutoBlend = FindAutomatedTarget<GlobalPostProcessingVolumeAutoBlend_URP>();
		...
		[FeedbackInspectorGroup("PostProcess Volume Blend", true, 22, true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			GlobalPostProcessingVolumeAutoBlend_URP.TimeScales timeScale = (ComputedTimescaleMode == TimescaleModes.Scaled) ? GlobalPostProcessingVolumeAutoBlend_URP.TimeScales.Scaled : GlobalPostProcessingVolumeAutoBlend_URP.TimeScales.Unscaled;
            PostProcessingVolumeAutoBlendURPShakeEvent.Trigger(ChannelData, TargetAutoBlend, Mode, BlendAction, ApplyTimeMultiplier(BlendDuration), BlendCurve, InitialWeight, FinalWeight, ResetToInitialValueOnEnd, NormalPlayDirection, timeScale);
		}
