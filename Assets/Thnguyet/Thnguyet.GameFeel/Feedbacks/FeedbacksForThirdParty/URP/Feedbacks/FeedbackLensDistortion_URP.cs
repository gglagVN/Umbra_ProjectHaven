...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with Lens Distortion active, and a LensDistortionShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_URP
	...
	[FeedbackHelp("This feedback allows you to control URP lens distortion intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with Lens Distortion active, and a LensDistortionShaker_URP component.")]
	public class FeedbackLensDistortion_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Lens Distortion", true, 22)]
		...
		[FeedbackInspectorGroup("Intensity", true, 23)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			LensDistortionShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			LensDistortionShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop:true, channelData: ChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			LensDistortionShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore:true, channelData: ChannelData);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<LensDistortion, LensDistortionShaker_URP>(Owner, "LensDistortion");
			#endif
		}
	}
}