...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackLight2D_URP : FeedbackFeedback
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return FeedbacksInspectorColors.LightColor; } }
		...
		[FeedbackInspectorGroup("Light", true, 37, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent, (int)Modes.ToDestination)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent, (int)Modes.Instant)]
		public bool RelativeValues = true;
		/// whether or not to reset shaker values after shake
		[Tooltip("whether or not to reset shaker values after shake")]
		[FeedbackEnumCondition("Mode", (int)Modes.ShakerEvent)]
		...
		[FeedbackInspectorGroup("Color", true, 38, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.OverTime, (int)Modes.ShakerEvent)]
		public Gradient ColorOverTime;
		/// the color to move to in instant mode
		[Tooltip("the color to move to in instant mode")]
		[FeedbackEnumCondition("Mode", (int)Modes.Instant, (int)Modes.ShakerEvent)]
		...
		[FeedbackInspectorGroup("Intensity", true, 39, true)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Instant)]
		...
		[FeedbackInspectorGroup("Falloff", true, 40, true)]
		...
		[FeedbackInspectorGroup("Shadow Strength", true, 41, true)]
		...
		[FeedbackInspectorGroup("Volumetric Intensity", true, 39, true)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			switch (Mode)
			{
				...
				case Modes.ShakerEvent:
					...
					Light2DShakeEvent.Trigger(FeedbackDuration, RelativeValues, ModifyColor, ColorOverTime, IntensityCurve,
		...
		protected virtual void SetLightValues(float time, float intensityMultiplier)
		{
			...
			{
				case Modes.OverTime:
					intensity = FeedbacksHelpers.Remap(IntensityCurve.Evaluate(time), 0f, 1f, RemapIntensityZero, RemapIntensityOne);
					volumeIntensity = FeedbacksHelpers.Remap(VolumetricIntensityCurve.Evaluate(time), 0f, 1f, RemapVolumetricIntensityZero, RemapVolumetricIntensityOne);
					falloff = FeedbacksHelpers.Remap(FalloffCurve.Evaluate(time), 0f, 1f, RemapFalloffZero, RemapFalloffOne);
					shadowStrength = FeedbacksHelpers.Remap(ShadowStrengthCurve.Evaluate(time), 0f, 1f, RemapShadowStrengthZero, RemapShadowStrengthOne);    
