...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// with MotionBlur active, and a MotionBlurShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	#if GAMEFEEL_URP
	...
	[FeedbackHelp("This feedback allows you to control motion blur intensity over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with MotionBlur active, and a MotionBlurShaker_URP component.")]
	public class FeedbackMotionBlur_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Motion Blur", true, 25)]
		...
		[FeedbackInspectorGroup("Intensity", true, 24)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			MotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, intensityMultiplier,
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			MotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, stop: true, channelData: ChannelData);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			MotionBlurShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero, RemapIntensityOne, RelativeIntensity, restore: true, channelData: ChannelData);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<MotionBlur, MotionBlurShaker_URP>(Owner, "MotionBlur");
			#endif
		}
	}
}