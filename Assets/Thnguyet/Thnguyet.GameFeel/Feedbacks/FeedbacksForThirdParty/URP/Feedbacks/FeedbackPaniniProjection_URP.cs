...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with Bloom active, and a PaniniProjectionShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	[FeedbackHelp("This feedback allows you to control Panini Projection distance and crop to fit over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with PaniniProjection active, and a PaniniProjectionShaker_URP component.")]
	#if GAMEFEEL_URP
	[FeedbackPath("PostProcess/Panini Projection URP")]
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.URP")]
	public class FeedbackPaniniProjection_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("Panini Projection", true, 28)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			PaniniProjectionShakeEvent_URP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, intensityMultiplier, ChannelData, 
		...
		protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
		{
			...
			PaniniProjectionShakeEvent_URP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData: ChannelData, stop: true);
		}
		...
		protected override void CustomRestoreInitialValues()
		{
			...
			PaniniProjectionShakeEvent_URP.Trigger(ShakeDistance, FeedbackDuration, RemapDistanceZero, RemapDistanceOne, RelativeDistance, channelData: ChannelData, restore: true);
		}
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<PaniniProjection, PaniniProjectionShaker_URP>(Owner, "PaniniProjection");
			#endif
		}
	}
}