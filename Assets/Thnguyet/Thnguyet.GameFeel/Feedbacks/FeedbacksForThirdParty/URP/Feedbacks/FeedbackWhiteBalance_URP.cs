...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	/// It requires you have in your scene an object with a Volume with White Balance active, and a WhiteBalanceShaker_URP component.
	/// </summary>
	[AddComponentMenu("")]
	[System.Serializable]
	[FeedbackHelp("This feedback allows you to control white balance temperature and tint over time. " +
	              "It requires you have in your scene an object with a Volume " +
	              "with WhiteBalance active, and a WhiteBalanceShaker_URP component.")]
	#if GAMEFEEL_URP
	[FeedbackPath("PostProcess/White Balance URP")]
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.URP")]
	public class FeedbackWhiteBalance_URP : FeedbackFeedback
	{
		...
		[FeedbackInspectorGroup("White Balance", true, 29)]
		...
		[FeedbackInspectorGroup("Temperature", true, 29)]
		...
		[FeedbackInspectorGroup("Tint", true, 29)]
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			WhiteBalanceShakeEvent_URP.Trigger(ShakeTemperature, FeedbackDuration, RemapTemperatureZero, RemapTemperatureOne,
		...
		public override void AutomaticShakerSetup()
		{
			...
			URPHelpers.GetOrCreateVolume<WhiteBalance, WhiteBalanceShaker_URP>(Owner, "WhiteBalance");
			#endif
		}
	}
}