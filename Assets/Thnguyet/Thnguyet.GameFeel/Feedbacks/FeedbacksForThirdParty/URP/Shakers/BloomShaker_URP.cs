...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Bloom Shaker URP")]
	public class BloomShaker_URP : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Bloom Intensity", true, 51)]
		...
		[InspectorGroup("Bloom Threshold", true, 52)]
		...
		{
			base.StartListening();
			BloomShakeEvent_URP.Register(OnBloomShakeEvent);
		}
		...
		{
			base.StopListening();
			BloomShakeEvent_URP.Unregister(OnBloomShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct BloomShakeEvent_URP
	{
