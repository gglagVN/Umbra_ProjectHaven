...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Channel Mixer Shaker URP")]
	public class ChannelMixerShaker_URP : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Red", true, 43)]
		...
		{
			base.StartListening();
			ChannelMixerShakeEvent_URP.Register(OnMMChannelMixerShakeEvent);
		}
		...
		{
			base.StopListening();
			ChannelMixerShakeEvent_URP.Unregister(OnMMChannelMixerShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct ChannelMixerShakeEvent_URP
	{
