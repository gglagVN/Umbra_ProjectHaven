...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Chromatic Aberration Shaker URP")]
	public class ChromaticAberrationShaker_URP : FeelShaker
	{
		[InspectorGroup("Chromatic Aberration Intensity", true, 45)]
		...
		{
			base.StartListening();
			ChromaticAberrationShakeEvent_URP.Register(OnMMChromaticAberrationShakeEvent);
		}
		...
		{
			base.StopListening();
			ChromaticAberrationShakeEvent_URP.Unregister(OnMMChromaticAberrationShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct ChromaticAberrationShakeEvent_URP
	{
