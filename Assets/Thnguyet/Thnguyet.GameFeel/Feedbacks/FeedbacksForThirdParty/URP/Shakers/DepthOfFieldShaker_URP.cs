...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Depth Of Field Shaker URP")]
	public class DepthOfFieldShaker_URP : FeelShaker
	{
		/// whether or not to add to the initial value
		public bool RelativeValues = true;

		[InspectorGroup("Focus Distance", true, 51)]
		...
		[InspectorGroup("Aperture", true, 52)]
		...
		[InspectorGroup("Focal Length", true, 53)]
		...
		{
			base.StartListening();
			DepthOfFieldShakeEvent_URP.Register(OnDepthOfFieldShakeEvent);
		}
		...
		{
			base.StopListening();
			DepthOfFieldShakeEvent_URP.Unregister(OnDepthOfFieldShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct DepthOfFieldShakeEvent_URP
	{
