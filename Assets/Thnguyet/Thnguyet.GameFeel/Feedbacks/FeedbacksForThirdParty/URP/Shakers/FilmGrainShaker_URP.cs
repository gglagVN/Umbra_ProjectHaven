...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Film Grain Shaker URP")]
	public class FilmGrainShaker_URP : FeelShaker
	{
		[InspectorGroup("Film Grain Intensity", true, 51)]
		...
		{
			base.StartListening();
			FilmGrainShakeEvent_URP.Register(OnFilmGrainShakeEvent);
		}
		...
		{
			base.StopListening();
			FilmGrainShakeEvent_URP.Unregister(OnFilmGrainShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct FilmGrainShakeEvent_URP
	{
