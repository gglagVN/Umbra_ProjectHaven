...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Lens Distortion Shaker URP")]
	public class LensDistortionShaker_URP : FeelShaker
	{
		[InspectorGroup("Lens Distortion Intensity", true, 51)]
		...
		{
			base.StartListening();
			LensDistortionShakeEvent_URP.Register(OnMMLensDistortionShakeEvent);
		}
		...
		{
			base.StopListening();
			LensDistortionShakeEvent_URP.Unregister(OnMMLensDistortionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct LensDistortionShakeEvent_URP
	{
