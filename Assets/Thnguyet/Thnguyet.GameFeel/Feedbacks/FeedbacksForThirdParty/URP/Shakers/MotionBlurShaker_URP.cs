...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Motion Blur Shaker URP")]
	public class MotionBlurShaker_URP : FeelShaker
	{
		[InspectorGroup("Motion Blur Intensity", true, 61)]
		...
		{
			base.StartListening();
			MotionBlurShakeEvent_URP.Register(OnMotionBlurShakeEvent);
		}
		...
		{
			base.StopListening();
			MotionBlurShakeEvent_URP.Unregister(OnMotionBlurShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct MotionBlurShakeEvent_URP
	{
