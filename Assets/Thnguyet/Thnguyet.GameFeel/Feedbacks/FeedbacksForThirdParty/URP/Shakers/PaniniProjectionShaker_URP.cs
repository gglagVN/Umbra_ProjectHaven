...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Panini Projection Shaker URP")]
	public class PaniniProjectionShaker_URP : FeelShaker
	{
		[InspectorGroup("Distance", true, 62)]
		...
		{
			base.StartListening();
			PaniniProjectionShakeEvent_URP.Register(OnPaniniProjectionShakeEvent);
		}
		...
		{
			base.StopListening();
			PaniniProjectionShakeEvent_URP.Unregister(OnPaniniProjectionShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct PaniniProjectionShakeEvent_URP
	{
