...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/Vignette Shaker URP")]
	public class VignetteShaker_URP : FeelShaker
	{
		[InspectorGroup("Vignette Intensity", true, 63)]
		...
		{
			base.StartListening();
			VignetteShakeEvent_URP.Register(OnVignetteShakeEvent);
		}
		...
		{
			base.StopListening();
			VignetteShakeEvent_URP.Unregister(OnVignetteShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct VignetteShakeEvent_URP
	{
