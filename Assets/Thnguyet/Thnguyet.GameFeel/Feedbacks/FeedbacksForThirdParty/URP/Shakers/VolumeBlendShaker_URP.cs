...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/VolumeBlendShaker_URP")]
	public class VolumeBlendShaker_URP : FeelShaker
	{
		[InspectorGroup("Configuration", true, 50)]
		...
		[InspectorGroup("Blend Shake Intensity", true, 51)]
		...
		{
			base.StartListening();
			VolumeBlendShakeEvent_URP.Register(OnVolumeBlendShakeEvent);
		}
		...
		{
			base.StopListening();
			VolumeBlendShakeEvent_URP.Unregister(OnVolumeBlendShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct VolumeBlendShakeEvent_URP
	{
