...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[AddComponentMenu("Thnguyet/GameFeel/Feedbacks/Shakers/PostProcessing/White Balance Shaker URP")]
	public class WhiteBalanceShaker_URP : FeelShaker
	{
		/// whether or not to add to the initial value
		[Tooltip("whether or not to add to the initial value")]
		public bool RelativeValues = true;

		[InspectorGroup("Temperature", true, 55)]
		...
		{
			base.StartListening();
			WhiteBalanceShakeEvent_URP.Register(OnWhiteBalanceShakeEvent);
		}
		...
		{
			base.StopListening();
			WhiteBalanceShakeEvent_URP.Unregister(OnWhiteBalanceShakeEvent);
		}
		#endif
	}
	...
	/// </summary>
	public struct WhiteBalanceShakeEvent_URP
	{
