...
{
	[AddComponentMenu("Thnguyet/GameFeel/Springs/Spring Chromatic Aberration Intensity URP")]
	public class SpringChromaticAberrationIntensity_URP : SpringFloatComponent<Volume>
	{
