...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	public class FeedbackVisualEffect : FeedbackFeedback 
	{
		...
		[FeedbackInspectorGroup("Visual Effect", true, 41)]
		/// the duration for the player to consider. This won't impact your visual effect, but is a way to communicate to the Feedback Player the duration of this feedback. Usually you'll want it to match your actual visual effect, and setting it can be useful to have this feedback work with holding pauses.
		[Tooltip("the duration for the player to consider. This won't impact your visual effect, but is a way to communicate to the Feedback Player the duration of this feedback. Usually you'll want it to match your actual visual effect, and setting it can be useful to have this feedback work with holding pauses.")]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.SetPlayRate)]
		...
		[FeedbackEnumCondition("Mode", (int)Modes.Simulate)]
