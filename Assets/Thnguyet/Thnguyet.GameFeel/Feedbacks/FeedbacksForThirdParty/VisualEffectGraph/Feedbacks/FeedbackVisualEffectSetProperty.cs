...
namespace Thnguyet.GameFeel.ThirdParty
{
	...
	#endif
	[MovedFrom(false, null, "Thnguyet.GameFeel.Feedbacks.VisualEffectGraph")]
	public class FeedbackVisualEffectSetProperty : FeedbackFeedback 
	{
		/// a static bool used to disable all feedbacks of this type at once
		public static bool FeedbackTypeAuthorized = true;
		/// sets the inspector color for this feedback
		#if UNITY_EDITOR
		public override Color FeedbackColor { get { return FeedbacksInspectorColors.ParticlesColor; } }
		#endif
		...
		[FeedbackInspectorGroup("Visual Effect Property", true, 41)]
		/// the duration for the player to consider. This won't impact your visual effect, but is a way to communicate to the Feedback Player the duration of this feedback. Usually you'll want it to match your actual particle system, and setting it can be useful to have this feedback work with holding pauses.
		[Tooltip("the duration for the player to consider. This won't impact your visual effect, but is a way to communicate to the Feedback Player the duration of this feedback. Usually you'll want it to match your actual particle system, and setting it can be useful to have this feedback work with holding pauses.")]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.AnimationCurve)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Bool)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Float)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Gradient)]
		[GradientUsage(true)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.UInt)]
		public uint NewUInt;
		/// if the property is a vector2, the new vector2 to set
		[Tooltip("if the property is a vector2, the new vector2 to set")]
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Vector2)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Vector3)]
		...
		[FeedbackEnumCondition("PropertyType", (int)PropertyTypes.Vector4)]
