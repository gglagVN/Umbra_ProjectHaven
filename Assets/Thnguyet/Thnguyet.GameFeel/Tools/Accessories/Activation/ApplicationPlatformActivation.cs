...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Activation/Application Platform Activation")]
	public class ApplicationPlatformActivation : MonoBehaviour
	{
		...
		protected virtual void DisableIfNeeded(PlatformBindings.PlatformActions platform, string platformName)
		{
			if (this.gameObject.activeInHierarchy && (platform == PlatformBindings.PlatformActions.Disable))
			{
				...
				{
					Debug.LogFormat(this.gameObject.name + " got disabled via PlatformActivation, platform : " + platformName + ".");
				}
			}
		}
	}
