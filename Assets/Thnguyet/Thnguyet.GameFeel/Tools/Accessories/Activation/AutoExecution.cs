...
{
	/// <summary>
	/// A data class to store auto execution info to be used in AutoExecution
	/// </summary>
	[System.Serializable]
	public class AutoExecutionItem
	{
	...
	/// </summary>
	public class AutoExecution : MonoBehaviour
	{
		/// a list of events to trigger automatically
		public List<AutoExecutionItem> Events;
		...
		{
			foreach (AutoExecutionItem item in Events)
			{
