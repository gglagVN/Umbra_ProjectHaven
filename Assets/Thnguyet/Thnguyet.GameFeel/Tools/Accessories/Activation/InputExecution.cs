...
{
	/// <summary>
	/// A class used to store InputExecution bindings, associating a target keycode to UnityEvents
	/// </summary>
	[System.Serializable]
	public class InputExecutionBinding
	{
		#if ENABLE_INPUT_SYSTEM && !ENABLE_LEGACY_INPUT_MANAGER
	...
	/// </summary>
	public class InputExecution : MonoBehaviour
	{
		[Header("Bindings")]
		/// a list of bindings
		public List<InputExecutionBinding> Bindings;
		...
		protected virtual void HandleInput()
		{
			...
			foreach(InputExecutionBinding binding in Bindings)
			{
