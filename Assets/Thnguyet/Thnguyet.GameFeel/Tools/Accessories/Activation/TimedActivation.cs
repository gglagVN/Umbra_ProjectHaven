...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Activation/Timed Activation")]
	public class TimedActivation : MonoBehaviour
	{
		...
		protected virtual IEnumerator TimedActivationSequence()
		{
			...
			{
				yield return FeelCoroutine.WaitFor(TimeBeforeStateChange);
			}
			else
			{
				yield return StartCoroutine(FeelCoroutine.WaitForFrames(FrameCount));
			}
			StateChange();
			Activate();
		}
