...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Camera/Aspect Ratio Safe Zones")]
	public class AspectRatioSafeZones : MonoBehaviour
	{
		[Header("Center")]
		...
		public Color CenterCrosshairColor = FeelColors.Wheat;
		...
		[InspectorButton("AutoSetup")]
		public bool AutoSetupButton;

		public virtual void AutoSetup()
		{
			Ratios.Clear();
			Ratios.Add(new Ratio(true, new Vector2(16, 9), FeelColors.DeepSkyBlue));
			Ratios.Add(new Ratio(true, new Vector2(16, 10), FeelColors.GreenYellow));
			Ratios.Add(new Ratio(true, new Vector2(4, 3), FeelColors.HotPink));
		}
	}
}
