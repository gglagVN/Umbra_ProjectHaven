...
namespace Thnguyet.GameFeel
{
	...
	public class CinemachineZone3D : CinemachineZone
	{
		...
		protected override void SetupConfiner()
		{
			...
			#if GAMEFEEL_CINEMACHINE
			_cinemachineConfiner = VirtualCamera.gameObject.GetComponentAroundOrAdd<CinemachineConfiner>();
			...
			#elif GAMEFEEL_CINEMACHINE3
			_cinemachineConfiner = VirtualCamera.gameObject.GetComponentAroundOrAdd<CinemachineConfiner3D>();
			if (_boxCollider != null)
			{
		...
		protected virtual void OnTriggerEnter(Collider collider)
		{
			...
			if (TriggerMask.Contains (collider.gameObject))
			{
				EnterZone();
			}
		}
