...
{
	public class FeelPlotter : MonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			if (Time.unscaledTime - _lastMovementEndedAt < MovementPauseDuration)
			{
				...
				{
					_currentMovement = 1f;
					_newScaleUnit = FeelTween.Tween(Time.unscaledTime - _lastMovementEndedAt, 0f, (MovementPauseDuration / 2f), 1f, 0f, FeelTween.TweenCurve.EaseInCubic);
				...
				{
					_currentMovement = 0f;
					_newScaleUnit = FeelTween.Tween(Time.unscaledTime - _lastMovementEndedAt, (MovementPauseDuration / 2f), MovementPauseDuration, 0f, 1f, FeelTween.TweenCurve.EaseOutCubic);
					_newScale = Vector3.one * _newScaleUnit;
