...
{
	/// <summary>
	/// A class used to handle the display of a debug log tab in a DebugMenu
	/// </summary>
	public class DebugMenuDebugTab : MonoBehaviour
	{
		...
		{
			FeelDebug.DebugLogEvent.Register(OnMMDebugLogEvent);
			DebugText.text = "";
		...
		protected virtual void Update()
		{
			...
			{
				_rectTransform.SetBottom(650f);
			}
			else
			{
				_rectTransform.SetBottom(0f);
			}
		}
		...
		protected virtual void OnMMDebugLogEvent(FeelDebug.DebugLogItem item)
		{
			DebugText.text = FeelDebug.LogHistoryText;
		...
		{
			FeelDebug.DebugLogEvent.Unregister(OnMMDebugLogEvent);
		}
	}
}
#endif