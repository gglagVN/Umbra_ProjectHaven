...
{
	/// <summary>
	/// Custom editor for the ScreenSafeZones component
	/// </summary>
	[CustomEditor(typeof(AspectRatioSafeZones), true)]
	[CanEditMultipleObjects]
	public class AspectRatioSafeZonesEditor : Editor
	{
		static AspectRatioSafeZones safeZones;
		...
		void OnEnable()
		{
			...
			safeZones = (AspectRatioSafeZones)target;
			SceneView.duringSceneGui += OnSceneGUI;            
		}
