...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	public class CleanEmptyFolders : MonoBehaviour
	{
		...
		/// </summary>
		[MenuItem("Tools/Thnguyet/GameFeel/Cleanup empty folders", false, 504)]
		protected static void CleanupMissingScripts()
		{
			...
			{
				_consoleLog = "[CleanEmptyFolders] Removed "+ _listOfEmptyDirectories.Count + " empty directories:\n";
				...
				FeelDebug.DebugLogInfo(_consoleLog);
				_consoleLog = "";
