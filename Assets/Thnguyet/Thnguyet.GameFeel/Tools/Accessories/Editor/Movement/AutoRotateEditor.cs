...
{
	/// <summary>
	/// Custom editor for the AutoRotate component
	/// </summary>
	[CustomEditor(typeof(AutoRotate), true)]
	...
	public class AutoRotateEditor : Editor
	{
		...
		static void DrawHandles(AutoRotate autoRotate, GizmoType gizmoType)
		{
			AutoRotate myTarget = autoRotate;
			...
			FeelDebug.DebugDrawArrow(origin, direction, myTarget.OrbitLineColor);
		}
	}
}