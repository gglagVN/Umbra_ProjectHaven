...
namespace Thnguyet.GameFeel
{
	...
	[CustomEditor(typeof(TrailRendererSortingLayer), true)]
	public class TrailRendererLayerEditor : Editor
	{
		int popupMenuIndex;
		string[] sortingLayerNames;
		protected TrailRendererSortingLayer _mmTrailRendererSortingLayer;
		protected TrailRenderer _trailRenderer;

		void OnEnable()
		{
			sortingLayerNames = GetSortingLayerNames(); 
			_mmTrailRendererSortingLayer = (TrailRendererSortingLayer)target;
