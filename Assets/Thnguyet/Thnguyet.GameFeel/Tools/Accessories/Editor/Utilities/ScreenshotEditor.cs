...
{
	[CustomEditor(typeof(AspectRatioSafeZones), true)]
	public class ScreenshotEditor : Editor
	{
		static string FolderName = "Screenshots";

		[MenuItem("Tools/Thnguyet/GameFeel/Screenshot/Take Screenshot Real Size", false, 801)]
		public static void MenuScreenshotSize1()
		{
			string savePath = TakeScreenCaptureScreenshot(1);
		}
		[MenuItem("Tools/Thnguyet/GameFeel/Screenshot/Take Screenshot Size x2", false, 802)]
		public static void MenuScreenshotSize2()
		{
			string savePath = TakeScreenCaptureScreenshot(2);
		}
		[MenuItem("Tools/Thnguyet/GameFeel/Screenshot/Take Screenshot Size x3 %k", false, 803)]
		...
		protected static string TakeScreenCaptureScreenshot(int gameViewSizeMultiplier)
		{
			...
			string savePath = FolderName + "/screenshot_" + width + "x" + height + "_" + System.DateTime.Now.ToString("yyyy-Feel-dd_HH-mm-ss") + ".png";

			ScreenCapture.CaptureScreenshot(savePath, gameViewSizeMultiplier);
			FeelDebug.DebugLogInfo("[FeelScreenshot] Screenshot taken with size multiplier of " + gameViewSizeMultiplier + " and saved at " + savePath);
			return savePath;
		}
	}
}
