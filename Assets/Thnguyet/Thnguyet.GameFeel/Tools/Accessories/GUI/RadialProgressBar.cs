...
namespace Thnguyet.GameFeel
{
	...
	/// This is a legacy class, and it's recommended to use FeelProgressBar instead, it'll provide the same functionality
	/// (make sure you pick FillAmount as the FillMode)
	/// and much more options, such as delayed bars, events, bump, and more!
	/// </summary>
	[Obsolete("This component is obsolete, it's recommended to use FeelProgressBar instead", true)]
	public class RadialProgressBar : MonoBehaviour 
	{
		...
		{
			_newPercent = FeelMaths.Remap(currentValue,minValue,maxValue,StartValue,EndValue);
