...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	public class FeelGizmo : MonoBehaviour 
	{
		/// <summary>
		...
		public Color GizmoColor = FeelColors.ReunoYellow; 
		...
		[Condition("DisplayText", true)]
		public Color TextColor = FeelColors.ReunoYellow; 
		...
		public PropertyPicker TargetProperty;
