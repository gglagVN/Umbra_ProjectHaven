...
namespace Thnguyet.GameFeel
{
	...
	public class RandomBoundsInstantiator : MonoBehaviour
	{
		...
		public virtual void InstantiateRandomObject()
		{
			...
			obj.transform.position = BoundsExtensions.RandomPointInBounds(_collider.bounds);
			...
			switch (ScaleMode)
			{
				...
				case ScaleModes.Vector3:
					_newScale = FeelMaths.RandomVector3(MinVectorScale, MaxVectorScale);
