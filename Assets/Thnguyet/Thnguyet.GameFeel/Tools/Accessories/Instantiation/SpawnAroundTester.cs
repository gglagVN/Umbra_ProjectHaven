...
{
	/// <summary>
	/// A tester class used to show how the SpawnAround class can be used
	/// </summary>
	public class SpawnAroundTester : MonoBehaviour
	{
		...
		public SpawnAroundProperties SpawnProperties;
		...
		public virtual void Spawn()
		{
			...
			SpawnAround.ApplySpawnAroundProperties(_gameObject, SpawnProperties, this.transform.position);
		}
		...
		protected virtual void OnDrawGizmos()
		{
			if (DrawGizmos)
			{
				SpawnAround.DrawGizmos(SpawnProperties, this.transform.position, GizmosQuantity, GizmosSize, Color.gray);    
			}
		}
	}
}