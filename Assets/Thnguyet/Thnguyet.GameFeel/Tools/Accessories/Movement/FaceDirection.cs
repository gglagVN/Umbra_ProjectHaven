...
namespace  Thnguyet.GameFeel
{
	...
	public class FaceDirection : MonoBehaviour
	{
		...
		/// </summary>
		protected virtual void ApplyFaceDirection()
		{
		...
		{
			if (UpdateMode == UpdateModes.Update) { ApplyFaceDirection(); }
		}
		...
		{
			if (UpdateMode == UpdateModes.LateUpdate) { ApplyFaceDirection(); }
		}
		...
		{
			if (UpdateMode == UpdateModes.FixedUpdate) { ApplyFaceDirection(); }
		}
	}
}