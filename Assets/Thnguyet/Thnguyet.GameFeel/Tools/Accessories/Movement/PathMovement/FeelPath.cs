...
namespace Thnguyet.GameFeel
{
	[System.Serializable]
	/// <summary>
	/// This class describes a node on an FeelPath
	/// </summary>
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Movement/Path")]
	public class FeelPath : MonoBehaviour 
	{
		...
		/// another FeelPath that you can reference. If set, the reference FeelPath's data will replace this FeelPath's
		public FeelPath ReferenceMMPath;
		...
		public virtual void Initialization()
		{
			...
			if (PathElements[0].PathElementPosition != Vector3.zero)
			{
				...
				foreach (PathMovementElement element in PathElements)
				{
		...
		{	
			...
			for (int i=0;i<PathElements.Count;i++)
			{
				...
				FeelDebug.DrawGizmoPoint(_originalTransformPosition+PathElements[i].PathElementPosition,0.2f,Color.green);
			...
			if (Application.isPlaying)
			{
				...
				{
					FeelDebug.DrawGizmoPoint(_originalTransformPosition + _currentPoint.Current,0.2f,Color.blue);
					FeelDebug.DrawGizmoPoint(_originalTransformPosition + _previousPoint,0.2f,Color.red);	
				}
			}
			#endif
		...
		/// <summary>
		/// Replaces this FeelPath's settings with the ones passed in parameters
		/// </summary>
