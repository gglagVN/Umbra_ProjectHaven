...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Movement/Path Movement")]
	public class PathMovement : MonoBehaviour 
	{
		...
		[Header("Movement")]
		[Information("Set the <b>speed</b> at which the path will be crawled, and if the movement should be constant or eased.",Thnguyet.GameFeel.InformationAttribute.InformationType.Info,false)]
		/// the movement speed
		...
		[Header("Settings")]
		[Information("The <b>MinDistanceToGoal</b> is used to check if we've (almost) reached a point in the Path. The 2 other settings here are for debug only, don't change them.",Thnguyet.GameFeel.InformationAttribute.InformationType.Info,false)]
		...
		public virtual void MoveAlongThePath()
		{
			switch (AccelerationType)
			{
				...
				case PossibleAccelerationType.AnimationCurve:
					...
					float remappedDistance = 1 - FeelMaths.Remap (_distanceToNextPoint, 0f, distanceBetweenPoints, 0f, 1f);
		...
		{	
			...
			for (int i=0;i<PathElements.Count;i++)
			{
				...
				FeelDebug.DrawGizmoPoint(PointPosition(i),0.2f,Color.green);
			...
			{
				FeelDebug.DrawGizmoPoint(PointPosition(_currentPoint.Current), 0.2f, Color.blue);
				FeelDebug.DrawGizmoPoint(PointPosition(_previousPoint),0.2f,Color.red);
			}
			#endif
		}
