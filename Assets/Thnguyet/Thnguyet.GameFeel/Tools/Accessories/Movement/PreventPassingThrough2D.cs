...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Movement/Prevent Passing Through 2D")]
	public class PreventPassingThrough2D : MonoBehaviour 
	{
		...
		{ 
			...
			{ 
				...
				{
					_hitInfo = FeelDebug.RayCast(_positionLastFrame, _lastMovement.normalized, movementMagnitude, ObstaclesLayerMask, Color.blue, true);	
				}
				else
				{
