...
namespace Thnguyet.GameFeel
{
	...
	public class RuntimeParticleControl : MonoBehaviour
	{
		/// <summary>
		...
		[InspectorButton("Play")] public bool PlayButton;
		/// a test button to pause the associated particle system
		[InspectorButton("Pause")] public bool PauseButton;
		/// a test button to stop the associated particle system
		[InspectorButton("Stop")] public bool StopButton;
		...
		[InspectorButton("Simulate")] public bool FastForwardToTimeButton;
		...
		protected void OnValidate()
		{
			...
			Timestamp = FeelMaths.Remap(Tracker, 0f, 1f, minBound, maxBound);
