...
{
	/// <summary>
	/// A class used to display a reoderable list of TilemapGeneratorLayers
	/// </summary>
	[System.Serializable]
	public class TilemapGeneratorLayerList : ReorderableArray<TilemapGeneratorLayer>
	{
	}
    
	/// <summary>
	/// A class used to store and edit the data of TilemapGenerator layers, which you can use and combine
	/// to generate unique and random grids
	/// </summary>
	[Serializable]
	public class TilemapGeneratorLayer
	{
		...
		[Condition("OverrideGridSize", true)]
		...
		public TilemapGenerator.GenerateMethods GenerateMethod = TilemapGenerator.GenerateMethods.Perlin;
		...
		[Condition("DoNotUseGlobalSeed", true)]
		...
		[EnumCondition("GenerateMethod", (int)TilemapGenerator.GenerateMethods.Full)]
		...
		[EnumCondition("GenerateMethod", (int)TilemapGenerator.GenerateMethods.Random)]
		...
		[EnumCondition("GenerateMethod", (int)TilemapGenerator.GenerateMethods.RandomWalkGround)]
		...
		[EnumCondition("GenerateMethod", (int)TilemapGenerator.GenerateMethods.RandomWalk)]
		...
		[EnumCondition("GenerateMethod", (int)TilemapGenerator.GenerateMethods.RandomWalkAvoider)]
		...
		[EnumCondition("GenerateMethod", (int) TilemapGenerator.GenerateMethods.Path)]
		...
		[EnumCondition("GenerateMethod", (int) TilemapGenerator.GenerateMethods.Path)]
		public GridGeneratorPath.Directions PathDirection = GridGeneratorPath.Directions.BottomToTop;
		...
		[EnumCondition("GenerateMethod", (int) TilemapGenerator.GenerateMethods.Copy)]
		...
		/// </summary>
		[Serializable]
		public struct TilemapGeneratorLayerSafeSpot
		{
		...
		public List<TilemapGeneratorLayerSafeSpot> SafeSpots;
		...
		public virtual void SetDefaults()
		{
			if (!Initialized)
			{
				GridWidth = 50;
				GridHeight = 50;
				GenerateMethod = TilemapGenerator.GenerateMethods.Perlin;
				RandomizeSeed = true;
				...
				PathDirection = GridGeneratorPath.Directions.BottomToTop;
				Initialized = true;
			}            
		}
		#endif
