...
namespace Thnguyet.GameFeel
{
	...
	public class AutoOrderInLayer : MonoBehaviour 
	{
		...
		[Header("Children")]
		[Information("And here you can decide to apply your new layer order to all children.",Thnguyet.GameFeel.InformationAttribute.InformationType.Info,false)]
