...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Utilities/Screenshot")]
	public class FeelScreenshot : MonoBehaviour
	{
		...
		[InspectorButton("TakeScreenshot")]
		...
		protected virtual void TakeScreenshot()
		{
			...
			FeelDebug.DebugLogInfo("[FeelScreenshot] Screenshot taken and saved at " + savePath);
		}
		...
		{
			string savePath = FolderName + "/screenshot_" + ResolutionWidth + "x" + ResolutionHeight + "_" + System.DateTime.Now.ToString("yyyy-Feel-dd_HH-mm-ss") + ".png";
