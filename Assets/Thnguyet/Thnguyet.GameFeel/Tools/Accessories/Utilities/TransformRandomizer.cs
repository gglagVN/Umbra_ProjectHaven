...
namespace Thnguyet.GameFeel
{
	...
	public class TransformRandomizer : MonoBehaviour
	{
		...
		[Condition("RandomizePosition", true)]
		...
		[Condition("RandomizeRotation", true)]
		...
		protected virtual void ProcessRandomizePosition()
		{
			...
			Vector3 randomPosition = FeelMaths.RandomVector3(MinRandomPosition, MaxRandomPosition);
		...
		protected virtual void ProcessRandomizeRotation()
		{
			...
			Vector3 randomRotation = FeelMaths.RandomVector3(MinRandomRotation, MaxRandomRotation);
		...
		protected virtual void ProcessRandomizeScale()
		{
			...
			Vector3 randomScale = FeelMaths.RandomVector3(MinRandomScale, MaxRandomScale);
