...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/VFX/Panning Texture")]
	public class PanningTexture : MonoBehaviour
	{
		[Information("This script will let you pan a texture on an attached Renderer.",Thnguyet.GameFeel.InformationAttribute.InformationType.Info,false)]
