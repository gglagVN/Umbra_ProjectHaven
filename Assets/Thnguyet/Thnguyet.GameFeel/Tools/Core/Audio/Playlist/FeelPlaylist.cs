...
namespace Thnguyet.GameFeel
{
	...
	public struct PlaylistPlayEvent
	{
	...
	public struct PlaylistStopEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistPauseEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistPlayNextEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistPlayPreviousEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistPlayIndexEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistVolumeMultiplierEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistPitchMultiplierEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	public struct PlaylistChangeEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
		...
		public delegate void Delegate(int channel, SMPlaylist newPlaylist, bool andPlay);
		static public void Trigger(int channel, SMPlaylist newPlaylist, bool andPlay)
		{
			OnEvent?.Invoke(channel, newPlaylist, andPlay);
		}
	}
	
	public struct PlaylistNewSongStartedEvent
	{
		static private event Delegate OnEvent;
		[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)] private static void RuntimeInitialization() { OnEvent = null; }
		static public void Register(Delegate callback) { OnEvent += callback; }
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Audio/Playlist")]
	[RequiresConstantRepaint]
	public class FeelPlaylist : FeelMonoBehaviour
	{
		...
		[InspectorGroup("Playlist Songs", true, 18)]
		...
		[InspectorGroup("Settings", true, 13)]
		...
		[InspectorGroup("Persistence", true, 32)]
		...
		[FeelReadOnly]
		public FeelStateMachine<FeelPlaylist.PlaylistStates> PlaylistState;

		[InspectorGroup("Tests", true, 15)]
		...
		/// a next song test button
		[InspectorButton("SetLoopTargetSong")]
		public bool SetLoopTargetSongButton;
		/// a next song test button
		[InspectorButton("StopLoopTargetSong")]
		...
		public static FeelPlaylist Current => _instance;
		protected static FeelPlaylist _instance;
		...
		public static FeelPlaylist Instance
		{
			get
			{
				if (_instance == null)
				{
					_instance = FindAnyObjectByType<FeelPlaylist> ();
					if (_instance == null)
					{
						GameObject obj = new GameObject ();
						obj.name = typeof(FeelPlaylist).Name + "_AutoCreated";
						_instance = obj.AddComponent<FeelPlaylist> ();
					}
				}
				return _instance;
			}
		...
		protected virtual void Initialization()
		{
			...
			_songsPlayedSoFar = 0;
			PlaylistState = new FeelStateMachine<FeelPlaylist.PlaylistStates>(this.gameObject, true);
		...
		protected virtual IEnumerator PlaySong(int index)
		{
			...
			// initial delay
			yield return FeelCoroutine.WaitFor(Random.Range(Songs[index].InitialDelay.x, Songs[index].InitialDelay.y));
		...
		protected virtual IEnumerator Fade(int index, float duration, float initialVolume, float endVolume, bool stopAtTheEnd)
		{
			...
			{
				progress = FeelMaths.Remap(Time.time - startTimestamp, 0f, duration, 0f, 1f);
