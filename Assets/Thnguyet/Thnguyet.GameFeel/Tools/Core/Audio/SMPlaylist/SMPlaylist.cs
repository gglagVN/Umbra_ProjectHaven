...
{
	/// <summary>
	/// A definition of a song, a part of a SM Playlist
	/// </summary>
	[Serializable]
	public class SMPlaylistSong
	{
		...
		public SoundManagerPlayOptions Options;
	...
	[CreateAssetMenu(menuName = "Thnguyet/GameFeel/Audio/SM Playlist")]
	[Serializable]
	public class SMPlaylist : ScriptableObject
	{
		...
		public FeelSoundManager.SoundManagerTracks Track = FeelSoundManager.SoundManagerTracks.Music;
		...
		[EnumCondition("PlayOrder", (int)PlayOrders.Random, (int)PlayOrders.RandomUnique)]
		...
		[EnumCondition("PlayMode", (int)PlayModes.PlayXTimes)]
		...
		[EnumCondition("PlayMode",(int)PlayModes.PlayOnce, (int)PlayModes.PlayXTimes)]
		public SMPlaylist NextPlaylist;
		/// the list of songs to play on this playlist
		[Tooltip("the list of songs to play on this playlist")]
		public List<SMPlaylistSong> Songs;
		...
		public virtual void Initialization()
		{
			...
			foreach (SMPlaylistSong song in Songs)
			{
				song.Initialization();
			}
		}
		...
		protected virtual void OnValidate()
		{
			foreach (SMPlaylistSong song in Songs)
			{
				...
				{
					song.Options = SoundManagerPlayOptions.Default;
				}
			}
		}
	}
