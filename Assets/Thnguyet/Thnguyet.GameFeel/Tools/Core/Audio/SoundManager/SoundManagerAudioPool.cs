...
namespace Thnguyet.GameFeel
{
	...
	public class SoundManagerAudioPool 
	{
		...
		public virtual IEnumerator AutoDisableAudioSource(float duration, AudioSource source, AudioClip clip, bool doNotAutoRecycleIfNotDonePlaying, float playbackTime, float playbackDuration)
		{
			...
			yield return FeelCoroutine.WaitForUnscaled(initialWait);
		...
		{
			GameObject temporaryAudioHost = new GameObject("AudioSourcePool_"+index);
			...
			FollowTarget followTarget = temporaryAudioHost.AddComponent<FollowTarget>();
