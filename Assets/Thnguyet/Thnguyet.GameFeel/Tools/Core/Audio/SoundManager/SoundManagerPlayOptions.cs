...
namespace Thnguyet.GameFeel
{
	...
	/// <summary>
	/// Stands in for UnityEngine.AudioResource, which only exists from Unity 6 onwards.
	/// On older editors it is never assigned, so the sound managers fall back to plain AudioClip playback.
	/// </summary>
	public class AudioResource : ScriptableObject { }
	#endif

	/// <summary>
	/// A class used to store options for FeelSoundManager play
	/// </summary>
	[Serializable]
	public struct SoundManagerPlayOptions
	{
		...
		public FeelSoundManager.SoundManagerTracks MmSoundManagerTrack;
		...
		/// options.MmSoundManagerTrack = FeelSoundManager.SoundManagerTracks.Music;
		///     
		...
		public static SoundManagerPlayOptions Default
		{
			get
			{
				...
				defaultOptions.MmSoundManagerTrack = FeelSoundManager.SoundManagerTracks.Sfx;
				...
				defaultOptions.FadeTween = TweenType.DefaultEaseInCubic;
