...
{
	/// <summary>
	/// This class stores FeelSoundManager settings and lets you tweak them from the SoundManagerSettingsSO's inspector
	/// </summary>
	[Serializable]
	public class SoundManagerSettings
	{
		...
		[Header("Save & Load")]
		/// whether or not the FeelSoundManager should automatically load settings when starting
		[Tooltip("whether or not the FeelSoundManager should automatically load settings when starting")]
		public bool AutoLoad = true;
		/// whether or not each change in the settings should be automaticall saved. If not, you'll have to call a save FeelSoundManager event for settings to be saved.
		[Tooltip("whether or not each change in the settings should be automaticall saved. If not, you'll have to call a save FeelSoundManager event for settings to be saved.")]
