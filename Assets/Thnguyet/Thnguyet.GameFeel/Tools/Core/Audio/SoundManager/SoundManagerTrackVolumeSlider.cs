...
namespace Thnguyet.GameFeel
{
	...
	/// via the FeelSoundManager
	/// </summary>
	public class SoundManagerTrackVolumeSlider :  MonoBehaviour, 
													...
													EventListener<SoundManagerTrackFadeEvent>
	{
		...
		{
			if (FeelSoundManager.HasInstance)
			{
		...
		protected virtual void LateUpdate()
		{
			if (Mode == Modes.Read)
			{
				float trackVolume = FeelSoundManager.Instance.GetTrackVolume(Track, false);
		...
		public virtual void UpdateVolume(float newValue)
		{
			...
			float newVolume = FeelMaths.Remap(newValue, 0f, 1f, MinVolume, MaxVolume);
			SoundManagerTrackEvent.Trigger(SoundManagerTrackEventTypes.SetVolumeTrack, Track, newVolume);
		}
		...
		public void OnMMEvent(SoundManagerEvent soundManagerEvent)
		{
			if (soundManagerEvent.EventType == SoundManagerEventTypes.SettingsLoaded)
			{
				UpdateSliderValueWithTrackVolume();
			}
		}
		...
		{
			_slider.value = FeelMaths.Remap(FeelSoundManager.Instance.GetTrackVolume(Track, false), 0f, 1f, MinVolume, MaxVolume);
		}
		...
		public void OnMMEvent(SoundManagerTrackEvent trackEvent)
		{
		...
		public void OnMMEvent(SoundManagerTrackFadeEvent fadeEvent)
		{
