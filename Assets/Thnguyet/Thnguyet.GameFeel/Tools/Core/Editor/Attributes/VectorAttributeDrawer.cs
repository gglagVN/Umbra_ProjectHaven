...
namespace Thnguyet.GameFeel
{
	...
	public class VectorLabelsAttributeDrawer : PropertyDrawer
	{
		...
		protected void DrawFieldsWithProperties(Rect rect, SerializedProperty[] properties, string mainLabel, VectorAttribute vectors, GUIContent originalGuiContent)
		{
