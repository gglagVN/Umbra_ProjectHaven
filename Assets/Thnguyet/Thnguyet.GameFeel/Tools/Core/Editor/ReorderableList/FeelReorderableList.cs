...
{
	public class FeelReorderableList {
		...
		public delegate void ActionDelegate(FeelReorderableList list);
		public delegate bool ActionBoolDelegate(FeelReorderableList list);
		public delegate void AddDropdownDelegate(Rect buttonRect, FeelReorderableList list);
		public delegate Object DragDropReferenceDelegate(Object[] references, FeelReorderableList list);
		public delegate void DragDropAppendDelegate(Object reference, FeelReorderableList list);
		public delegate float GetElementHeightDelegate(SerializedProperty element);
		public delegate float GetElementsHeightDelegate(FeelReorderableList list);
		...
		public FeelReorderableList(SerializedProperty list)
			: this(list, true, true, true) {
		}

		public FeelReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable)
			: this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null) {
		}

		public FeelReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon) 
			: this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon) {
		}

		public FeelReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon) {
