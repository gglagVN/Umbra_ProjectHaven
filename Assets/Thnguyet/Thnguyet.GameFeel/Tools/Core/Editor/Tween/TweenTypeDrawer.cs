...
{
	[CustomPropertyDrawer(typeof(TweenType))]
	public class TweenTypeDrawer : PropertyDrawer
	{
		...
		{
			var type = property.FindPropertyRelative("TweenDefinitionType");
			...
			EditorGUI.PropertyField(definitionTypeRect, property.FindPropertyRelative("TweenDefinitionType"), GUIContent.none);
			if (type.enumValueIndex == 0)
			{
				EditorGUI.PropertyField(curveRect, property.FindPropertyRelative("TweenCurve"), GUIContent.none);
			}
