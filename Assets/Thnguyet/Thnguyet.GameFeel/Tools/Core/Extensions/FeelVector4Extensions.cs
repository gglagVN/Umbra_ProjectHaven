...
namespace Thnguyet.GameFeel
{
	...
	/// Vector4 Extensions
	/// </summary>
	public static class FeelVector4Extensions
	{
		/// <summary>
		...
		/// <param name="newValue"></param>
		/// <returns></returns>
		public static Vector4 Invert(this Vector4 newValue)
		{
			return new Vector4
			(
				1.0f / newValue.x,
		...
		/// <returns></returns>
		public static Vector4 Project(this Vector4 vector, Vector4 projectedVector)
		{
		...
		/// <returns></returns>
		public static Vector4 Reject(this Vector4 vector, Vector4 rejectedVector)
		{
