...
namespace Thnguyet.GameFeel
{
	...
	public static class GameObjectExtensions
	{
		...
		public static T InstantiateDisabled<T>(T originalObject, Transform parent = null, bool worldPositionStays = false) where T : Object
		{
			...
			(GameObject coreObject, Transform coreObjectTransform) = CreateDisabledObject(parent);
		...
		public static T InstantiateDisabled<T>(T originalObject, Vector3 position, Quaternion rotation, Transform parent = null) where T : Object
		{
			...
			(GameObject newObject, Transform newObjectTransform) = CreateDisabledObject(parent);
		...
		private static (GameObject coreObject, Transform newObjectTransform) CreateDisabledObject(Transform parent = null)
		{
