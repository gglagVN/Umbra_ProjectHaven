...
{
	public static class FeelCoroutine
	{
		/// <summary>
		/// Waits for the specified amount of frames
		/// use : yield return FeelCoroutine.WaitFor(1);
		/// </summary>
		...
		/// use : yield return FeelCoroutine.WaitFor(1f);
		/// </summary>
		...
		/// use : yield return FeelCoroutine.WaitForUnscaled(1f);
		/// </summary>
		/// <param name="seconds"></param>
		/// <returns></returns>
