...
{	
	...
	public class FeelInput : MonoBehaviour 
	{
		...
		public class IMButton
		{
			...
			public FeelStateMachine<FeelInput.ButtonStates> State {get;protected set;}
			...
			public IMButton(string playerID, string buttonID, ButtonDownMethodDelegate btnDown = null, ButtonPressedMethodDelegate btnPressed = null, ButtonUpMethodDelegate btnUp = null) 
			{
				...
				State = new FeelStateMachine<FeelInput.ButtonStates> (null, false);
				State.ChangeState (FeelInput.ButtonStates.Off);
			}
			
			/// <summary>
			/// Returns true if the button is currently pressed
			/// </summary>
			public virtual bool IsPressed => State.CurrentState == FeelInput.ButtonStates.ButtonPressed;
			
			/// <summary>
			/// Returns true if the button is down this frame 
			/// </summary>
			public virtual bool IsDown => State.CurrentState == FeelInput.ButtonStates.ButtonDown;
			
			/// <summary>
			/// Returns true if the button is up this frame
			/// </summary>
			public virtual bool IsUp => State.CurrentState == FeelInput.ButtonStates.ButtonUp;
			
			/// <summary>
			/// Returns true if the button is neither pressed, down or up this frame
			/// </summary>
			public virtual bool IsOff => State.CurrentState == FeelInput.ButtonStates.Off;
			...
			public virtual void TriggerButtonDown()
			{
				...
				{
					State.ChangeState(FeelInput.ButtonStates.ButtonDown);
				}
				else
				{
					ButtonDownMethod();
			...
			public virtual void TriggerButtonPressed()
			{
				...
				{
					State.ChangeState(FeelInput.ButtonStates.ButtonPressed);
				}
				else
				{
					ButtonPressedMethod();
			...
			public virtual void TriggerButtonUp()
			{
				...
				{
					State.ChangeState(FeelInput.ButtonStates.ButtonUp);
				}
				else
				{
					ButtonUpMethod();
