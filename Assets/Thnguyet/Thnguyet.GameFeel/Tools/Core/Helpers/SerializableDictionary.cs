...
namespace Thnguyet.GameFeel
{
	...
	/// How to use :
	///
	/// For each type of dictionary you want to serialize, create a serializable class that inherits from SerializableDictionary,
	...
	public class SerializableDictionary<TKey, TValue> : Dictionary<TKey, TValue>, ISerializationCallbackReceiver
	{
		...
		public void OnAfterDeserialize()
		{
			...
			{
				Debug.LogError("SerializableDictionary : there are " + _keys.Count + " keys and " + _values.Count + " values after deserialization. Counts need to match, make sure both key and value types are serializable.");
			}
