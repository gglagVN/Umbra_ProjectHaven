...
namespace Thnguyet.GameFeel
{
	...
	/// 
	/// public FeelObservable<float> Speed;
	/// 
	...
	/// {
	///     FeelDebug.DebugLogInfo(_myCharacter.Speed.Value);
	/// }
	/// 
	/// You can look at the ObservableTest demo scene for an example of how it's used.
	/// 
	/// </summary>
	/// <typeparam name="T"></typeparam>
	public struct FeelObservable<T>
	{
