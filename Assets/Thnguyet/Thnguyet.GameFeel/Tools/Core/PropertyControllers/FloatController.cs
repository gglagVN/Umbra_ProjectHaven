...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Property Controllers/Float Controller")]
	[RequiresConstantRepaint]
	public class FloatController : FeelMonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			switch (ControlMode)
			{
				...
				case ControlModes.OneTime:
					...
					_remappedTimeSinceStart = FeelMaths.Remap(GetTime() - _shakeStartTimestamp, 0f, OneTimeDuration, 0f, 1f);
				...
				case ControlModes.ToDestination:
					...
					_remappedTimeSinceStart = FeelMaths.Remap(GetTime() - _shakeStartTimestamp, 0f, ToDestinationDuration, 0f, 1f);
