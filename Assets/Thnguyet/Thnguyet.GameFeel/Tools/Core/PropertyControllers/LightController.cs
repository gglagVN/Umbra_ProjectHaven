...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Property Controllers/Light Controller")]
	public class LightController : MonoBehaviour
	{
		[Header("Binding")]
		[Information("Use this component to control the properties of one or more lights at runtime. Plays well with a FloatController. " +
		               "This component will try to auto set the TargetLight if there's a Light component on this object.", Thnguyet.GameFeel.InformationAttribute.InformationType.Info, false)]
