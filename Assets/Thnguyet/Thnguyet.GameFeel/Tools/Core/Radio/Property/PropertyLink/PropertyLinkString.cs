...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	public class PropertyLinkString : PropertyLink
	{
		...
		/// <param name="property"></param>
		/// <returns></returns>
		protected virtual string GetValueOptimized(FeelProperty property)
		{
		...
		protected virtual void SetValueOptimized(FeelProperty property, string newValue)
		{
