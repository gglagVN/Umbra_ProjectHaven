...
namespace Thnguyet.GameFeel
{
	...
	/// This inherits from PersistentBase and implements the IMMPersistent interface
	/// It's a good example of how to implement the interface's OnSave and OnLoad methods
	/// </summary>
	public class FeelPersistent : PersistentBase
	{
		...
		/// <summary>
		/// On Save, we turn the object's transform data and active state to a Json string and return it to the PersistencyManager
		/// </summary>
		/// <returns></returns>
