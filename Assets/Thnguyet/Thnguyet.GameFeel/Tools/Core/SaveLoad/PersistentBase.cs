...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("")]
	public class PersistentBase : MonoBehaviour, IMMPersistent
	{
		[Header("Save")] 
		...
		{
			return Resources.FindObjectsOfTypeAll<PersistentBase>().Count(x => x.GetGuid() == guid) == 1;
		}
