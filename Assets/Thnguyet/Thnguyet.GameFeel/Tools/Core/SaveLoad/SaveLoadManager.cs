...
namespace Thnguyet.GameFeel
{
	...
	/// 
	/// Load : TestObject = (YourObjectClass)SaveLoadManager.Load(typeof(YourObjectClass), FileName + SaveFileExtension, FolderName);
	/// 
	...
	public static class SaveLoadManager
	{
		...
		public static IMMSaveLoadManagerMethod SaveLoadMethod = new SaveLoadManagerMethodBinary();
		...
		public static object Load(System.Type objectType, string fileName, string foldername = _defaultFolderName)
		{
			...
			// if the Saves directory or the save file doesn't exist, there's nothing to load, we do nothing and exit
		...
		/// <summary>
		/// Deletes all save files saved by this SaveLoadManager
		/// </summary>
