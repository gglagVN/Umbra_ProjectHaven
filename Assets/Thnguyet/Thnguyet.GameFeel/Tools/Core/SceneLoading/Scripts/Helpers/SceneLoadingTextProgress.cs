...
{	
	/// <summary>
	/// A very simple class, meant to be used within a SceneLoading screen, to update a Text
	/// based on loading progress
	/// </summary>
	public class SceneLoadingTextProgress : MonoBehaviour
	{
		...
		{
			float remappedValue = FeelMaths.Remap(newValue, 0f, 1f, RemapMin, RemapMax);
			float displayValue = FeelMaths.RoundToDecimal(remappedValue, NumberOfDecimals);
