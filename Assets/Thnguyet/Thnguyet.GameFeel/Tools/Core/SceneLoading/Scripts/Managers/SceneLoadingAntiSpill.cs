...
{
	/// <summary>
	/// This helper class, meant to be used by the AdditiveSceneLoadingManager, creates a temporary scene to store objects that might get instantiated, and empties it in the destination scene once loading is complete
	/// </summary>
