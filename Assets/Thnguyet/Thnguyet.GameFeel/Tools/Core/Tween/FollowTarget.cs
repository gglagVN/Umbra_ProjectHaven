...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Movement/Follow Target")]
	public class FollowTarget : MonoBehaviour
	{
		...
		[Condition("InterpolatePosition", true)]
		...
		[EnumCondition("FollowPositionMode", (int)FollowModes.Spring)] 
		[Range(0.01f, 1.0f)]
		...
		[Condition("InterpolateRotation", true)]
		...
		/// higher values mean more damping, less spring, low values mean less damping, more spring
		[EnumCondition("FollowRotationMode", (int)FollowModes.Spring)] 
		[Range(0.01f, 1.0f)]
		...
		[Condition("InterpolateScale", true)]
		...
		/// higher values mean more damping, less spring, low values mean less damping, more spring
		[EnumCondition("FollowScaleMode", (int)FollowModes.Spring)] 
		[Range(0.01f, 1.0f)]
		...
		[Condition("AnchorToInitialPosition", true)]
			...
			if (InterpolatePosition)
			{
				switch (FollowPositionMode)
				{
					case FollowModes.Lerp:
						interpolatedDistance = FeelMaths.Lerp(0f, trueDistance, FollowPositionSpeed, Time.deltaTime);
					...
					case FollowModes.Spring:
						...
						FeelMaths.Spring(ref _newPosition, _newTargetPosition, ref _positionVelocity, PositionSpringDamping, PositionSpringFrequency, Time.deltaTime);
						if (_localSpace)
						{
		...
		protected virtual void FollowTargetRotation()
		{
			...
			if (FollowRotationMode == FollowModes.Spring && (_newTargetRotationEulerAnglesLastFrame != _newTargetRotationEulerAngles))
			{
			...
			if (InterpolateRotation)
			{
				...
				{
					case FollowModes.Lerp:
						this.transform.rotation = FeelMaths.Lerp(this.transform.rotation, _newTargetRotation, FollowRotationSpeed, Time.deltaTime);
						break;
					case FollowModes.RegularLerp:
					...
					case FollowModes.Spring:
						...
						FeelMaths.Spring(ref _rotationFloatCurrent, _rotationFloatTarget, ref _rotationFloatVelocity, RotationSpringDamping, RotationSpringFrequency, Time.deltaTime);
						float lerpValue = FeelMaths.Remap(_rotationFloatCurrent, 0f, _rotationFloatTarget, 0f, 1f);
		...
		protected virtual void FollowTargetScale()
		{
			...
			if (InterpolateScale)
			{
				...
				{
					case FollowModes.Lerp:
						this.transform.localScale = FeelMaths.Lerp(this.transform.localScale, _newTargetScale, FollowScaleSpeed, Time.deltaTime);
						break;
					case FollowModes.RegularLerp:
					...
					case FollowModes.Spring:
						...
						FeelMaths.Spring(ref _newScale, _newTargetScale, ref _scaleVelocity, ScaleSpringDamping, ScaleSpringFrequency, Time.deltaTime);
