...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Achievements/Achievement Displayer")]
	public class AchievementDisplayer : MonoBehaviour, EventListener<AchievementUnlockedEvent>
	{
		[Header("Achievements")]
		...
		public virtual IEnumerator DisplayAchievement(FeelAchievement achievement)
		{
			...
			{
				SfxEvent.Trigger (achievement.UnlockedSound);
			}
			...
			if (achievementCanvasGroup != null)
			{
				...
				StartCoroutine(FeelFade.FadeCanvasGroup(achievementCanvasGroup, AchievementFadeDuration, 1));
				yield return _achievementFadeOutWFS;
				StartCoroutine(FeelFade.FadeCanvasGroup(achievementCanvasGroup, AchievementFadeDuration, 0));
			}
		}
		...
		public virtual void OnMMEvent(AchievementUnlockedEvent achievementUnlockedEvent)
		{
		...
		{
			this.EventStartListening<AchievementUnlockedEvent>();
		...
		{
			this.EventStopListening<AchievementUnlockedEvent>();
		}
	}
}
#endif
