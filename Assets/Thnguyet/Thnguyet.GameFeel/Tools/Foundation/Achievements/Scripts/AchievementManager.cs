...
namespace Thnguyet.GameFeel
{
	...
	{
		public static List<FeelAchievement> AchievementsList { get { return _achievements; }}

		private static List<FeelAchievement> _achievements;
		private static FeelAchievement _achievement = null;

		public static string _defaultFileName = "Achievements";
		public static string _saveFolderName = "Achievements/";
		...
		/// </summary>
		public static void LoadAchievementList(AchievementList achievementList)
		{
			_achievements = new List<FeelAchievement> ();
			...
			foreach (FeelAchievement achievement in achievementList.Achievements)
			{
		...
		private static FeelAchievement AchievementManagerContains(string searchedID)
		{
			if (_achievements.Count == 0)
			{
				return null;
			}
			foreach(FeelAchievement achievement in _achievements)
			{
		...
		public static void ResetAchievements(string listID)
		{
			...
			SaveLoadManager.DeleteSave(SaveFileName + _saveFileExtension, _saveFolderName);
		...
		{
			DeterminePath ();
			SerializedMMAchievementManager serializedMMAchievementManager = (SerializedMMAchievementManager)SaveLoadManager.Load(typeof(SerializedMMAchievementManager), SaveFileName+ _saveFileExtension, _saveFolderName);
		...
		public static void SaveAchievements()
		{
			...
			SaveLoadManager.Save(serializedMMAchievementManager, SaveFileName+_saveFileExtension, _saveFolderName);
		}
