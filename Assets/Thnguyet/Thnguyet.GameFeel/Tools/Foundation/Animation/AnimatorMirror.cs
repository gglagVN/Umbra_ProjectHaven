...
namespace Thnguyet.GameFeel
{
	...
	public class AnimatorMirror : MonoBehaviour
	{
		...
		public struct AnimatorMirrorBind
		{
		...
		protected List<AnimatorMirrorBind> _updateParameters;
		...
		public virtual void Initialization()
		{
			...
			_updateParameters = new List<AnimatorMirrorBind>();
			...
			foreach (AnimatorControllerParameter sourceParam in _sourceParameters)
			{
				foreach (AnimatorControllerParameter targetParam in _targetParameters)
				{
					...
					{
						AnimatorMirrorBind bind = new AnimatorMirrorBind();
		...
		protected virtual void Mirror()
		{
			...
			foreach (AnimatorMirrorBind bind in _updateParameters)
			{
