...
{	
	/// <summary>
	/// This persistent singleton handles the inputs and sends commands to the player in the Controls demo, its sole purpose is to output debug logs of the various interactions with the demo's inputs
	/// </summary>
	public class ControlsTestInputManager : MonoBehaviour, EventListener<FeelSwipeEvent>
	{
		...
		public virtual void LeftJoystickMovement(Vector2 movement) { FeelDebug.DebugOnScreen("left joystick",movement); }
		public virtual void RightJoystickMovement(Vector2 movement) { FeelDebug.DebugOnScreen("right joystick", movement); }
		public virtual void RepositionableJoystickMovement(Vector2 movement) { FeelDebug.DebugOnScreen("Repositionable joystick", movement); }
		public virtual void FollowerJoystickMovement(Vector2 movement) { FeelDebug.DebugOnScreen("Follower joystick", movement); }

		public virtual void APressed() { FeelDebug.DebugOnScreen("Button A Pressed"); }
		public virtual void BPressed() { FeelDebug.DebugOnScreen("Button B Pressed"); }
		public virtual void XPressed() { FeelDebug.DebugOnScreen("Button X Pressed"); }
		public virtual void YPressed() { FeelDebug.DebugOnScreen("Button Y Pressed"); }
		public virtual void RTPressed()	{ FeelDebug.DebugOnScreen("Button RT Pressed"); }
		...
		public virtual void HorizontalAxisPressed(float value) { FeelDebug.DebugOnScreen("horizontal movement",value); }
		public virtual void VerticalAxisPressed(float value) { FeelDebug.DebugOnScreen("vertical movement",value); }
		...
		public virtual void OnMMEvent(FeelSwipeEvent swipeEvent)
		{
		...
		{
			this.EventStartListening<FeelSwipeEvent>();
		}

		protected virtual void OnDisable()
		{
			this.EventStopListening<FeelSwipeEvent>();
		}
	}
}
