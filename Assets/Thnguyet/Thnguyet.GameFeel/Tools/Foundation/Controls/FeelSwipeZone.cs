...
{	
	...
	/// </summary>
	public enum PossibleSwipeDirections { Up, Down, Left, Right }


	[System.Serializable]
	public class SwipeEvent : UnityEvent<FeelSwipeEvent> {}
	...
	/// </summary>
	public struct FeelSwipeEvent
	{
		public PossibleSwipeDirections SwipeDirection;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Thnguyet.GameFeel.FeelSwipeEvent"/> struct.
		/// </summary>
		...
		public FeelSwipeEvent(PossibleSwipeDirections direction, float angle, float length, Vector2 origin, Vector2 destination, float swipeDuration)
		{
		...
		static FeelSwipeEvent e;
		public static void Trigger(PossibleSwipeDirections direction, float angle, float length, Vector2 origin, Vector2 destination, float swipeDuration)
		{
	...
	/// <summary>
	/// Add a swipe manager to your scene, and it'll trigger SwipeEvents everytime a swipe happens. From its inspector you can determine the minimal length of a swipe. Shorter swipes will be ignored
	/// </summary>
	[RequireComponent(typeof(RectTransform))]
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Controls/Swipe Zone")]
	public class FeelSwipeZone : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler
	{
		...
		protected PossibleSwipeDirections _swipeDirection;
		...
		protected virtual void Swipe()
		{
			...
			FeelSwipeEvent swipeEvent = new FeelSwipeEvent (_swipeDirection, _angle, _length, _firstTouchPosition, _destination, duration);
			FeelEventManager.TriggerEvent(swipeEvent);
			if (ZoneSwiped != null)
			{
		...
		public virtual void OnPointerUp(PointerEventData data)
		{
			...
			{
				_angle = FeelMaths.AngleBetween (_deltaSwipe, Vector2.right);
		...
		protected virtual PossibleSwipeDirections AngleToSwipeDirection(float angle)
		{
			if ((angle < 45) || (angle >= 315))
			{
				return PossibleSwipeDirections.Right;
			}
			if ((angle >= 45) && (angle < 135))
			{
				return PossibleSwipeDirections.Up;
			}
			if ((angle >= 135) && (angle < 225))
			{
				return PossibleSwipeDirections.Left;
			}
			if ((angle >= 225) && (angle < 315))
			{
				return PossibleSwipeDirections.Down;
			}
			return PossibleSwipeDirections.Right;
		}
	}
