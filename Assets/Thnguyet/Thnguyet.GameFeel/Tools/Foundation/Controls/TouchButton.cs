...
namespace Thnguyet.GameFeel
{
	...
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Controls/Touch Button")]
	public class TouchButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
	{
		...
		[Condition("DisabledChangeColor", true)]
		...
		[Condition("PressedChangeColor", true)]
		...
		[Condition("HighlightedChangeColor", true)]
