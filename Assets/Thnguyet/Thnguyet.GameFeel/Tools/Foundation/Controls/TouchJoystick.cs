...
namespace Thnguyet.GameFeel 
{
	...
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Controls/Touch Joystick")]
	public class TouchJoystick : FeelMonoBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
	{
		public enum MaxRangeModes { Distance, DistanceToTransform }
		
		[InspectorGroup("Camera", true, 16)]
		...
		[InspectorGroup("Joystick Behaviour", true, 18)]
		...
		[EnumCondition("MaxRangeMode", (int)MaxRangeModes.Distance)]
		...
		[EnumCondition("MaxRangeMode", (int)MaxRangeModes.DistanceToTransform)]
		...
		[InspectorGroup("Value Events", true, 19)]
		...
		[InspectorGroup("Touch Events", true, 8)]
		...
		[InspectorGroup("Rotating Direction Indicator", true, 20)]
		...
		[InspectorGroup("Knob Opacity", true, 17)]
		...
		[Condition("InterpolateOpacity", true)]
		public float InterpolateOpacitySpeed = 1f;
		
		[InspectorGroup("Debug Output", true, 5)]
		...
		protected virtual void HandleOpacity()
		{
			...
			{
				_canvasGroup.alpha = FeelMaths.Lerp(_canvasGroup.alpha, _targetOpacity, InterpolateOpacitySpeed, Time.unscaledDeltaTime);	
			}
			else
			{
