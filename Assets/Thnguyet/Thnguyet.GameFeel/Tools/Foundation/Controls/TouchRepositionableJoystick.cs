...
namespace Thnguyet.GameFeel
{
	...
	/// </summary>
	[AddComponentMenu("Thnguyet/GameFeel/Tools/Controls/Touch Repositionable Joystick")]
	public class TouchRepositionableJoystick : TouchJoystick, IPointerDownHandler
	{
		[InspectorGroup("Repositionable Joystick", true, 22)]
