...
namespace  Thnguyet.GameFeel
{
	...
	public class LootTable<T,V> where T:FeelLoot<V>
	{
	...
	/// <summary>
	/// A LootTable implementation for GameObjects
	/// </summary>
	[System.Serializable]
	public class LootTableGameObject : LootTable<LootGameObject, GameObject> { } 
    
	/// <summary>
	/// A LootTable implementation for floats
	/// </summary>
	[System.Serializable]
	public class LootTableFloat : LootTable<LootFloat, float> { } 
    
	/// <summary>
	/// A LootTable implementation for strings
	/// </summary>
	[System.Serializable]
	public class LootTableString : LootTable<LootString, string> { } 
}
