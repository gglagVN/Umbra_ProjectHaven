...
namespace Thnguyet.ScriptableObjectArchitecture.Editor
{
    ...
    public class CollectionEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (CollectionItemsProperty != null)
            {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("The collection property could not be found. Ensure the collection's generic type is serializable.", MessageType.Warning);
                base.OnInspectorGUI();
            }
        }
