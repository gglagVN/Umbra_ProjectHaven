...
namespace Thnguyet.UI
{
    public class BaseUIComp : MonoBehaviour
    {
        ...
        public void AutoReference()
        {
            ...
            foreach (var field in this.GetType().GetFields(System.Reflection.BindingFlags.Public |
                                                           System.Reflection.BindingFlags.NonPublic |
                                                           System.Reflection.BindingFlags
                                                               .Instance) /*.Where(field => field.GetValue(this) == null)*/
            )
            {
