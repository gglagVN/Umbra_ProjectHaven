...
using Thnguyet.UnityExtensions.Tween.Editor;

namespace Thnguyet.UnityExtensions.Tween
{
            ...
            public override void OnInspectorGUI()
            {
               ...
               //  }
                ...
                if (!serializedObject.isEditingMultipleObjects)
                {
                    ...
                    // Mouse end drag
                    if (UnityEngine.Event.current.rawType == EventType.MouseUp && target.dragging)
                    {
